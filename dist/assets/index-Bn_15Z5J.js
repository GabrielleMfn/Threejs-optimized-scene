...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function zs(e,t,n){let r=new Float32Array(Ts),i=new G(0,1,0);return new ja({name:`SphericalGaussianBlur`,defines:{n:Ts,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Hs(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Bs(){return new ja({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Hs(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Vs(){return new ja({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Hs(),fragmentShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},Pu={name:`LuminosityHighPassShader`,uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new Y(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		}`};function Ku(e,t){let n=new Fo(13164799,.24);e.add(n);let r=new ho(12182271,9810298,.34);e.add(r);let i=new Po(16777215,1.35);i.position.set(-42,64,-18),e.add(i);let a=new Po(14217471,.18);a.position.set(36,24,28),e.add(a);let o=new Po(15858687,.08);o.position.set(32,14,28),e.add(o);let s=new Gu;s.scale.setScalar(45e4),e.add(s);let c=s.material.uniforms;c.turbidity.value=10,c.rayleigh.value=3,c.mieCoefficient.value=.005,c.mieDirectionalG.value=.7,c.cloudCoverage.value=.28,c.cloudDensity.value=.22,c.cloudElevation.value=.42,c.showSunDisc.value=1;let l=new G,u=kt.degToRad(82),d=kt.degToRad(180);if(l.setFromSphericalCoords(1,u,d),c.sunPosition.value.copy(l),e.background=new Y(10405855),e.fog.color.set(12112075),t){let n=new Ps(t),r=new Fn;r.add(s),e.environment=n.fromScene(r).texture,s.material.uniforms.showSunDisc.value=0,e.add(s)}}var qu=new G(-26,0,18),Ju=[new G(6,0,90),new G(14,0,78),new G(22,0,66),new G(18,0,54),new G(6,0,42),new G(-8,0,31),new G(-18,0,22),new G(-20,0,10),new G(-10,0,-3),new G(4,0,-16),new G(18,0,-29),new G(22,0,-43),new G(12,0,-56),new G(-2,0,-68),new G(-16,0,-80),new G(-24,0,-90)];function Yu(){return new ya(Ju.map(e=>e.clone()),!1,`centripetal`,.28)}function Xu(e,t,n){if(e===t)return 0;let r=Math.max(0,Math.min(1,(n-e)/(t-e)));return r*r*(3-2*r)}function Zu(e,t,n,r=96){let i=1/0;for(let a=0;a<=r;a+=1){let o=e.getPointAt(a/r),s=Math.hypot(t-o.x,n-o.z);s<i&&(i=s)}return i}var Qu=`/Threejs-optimized-scene/assets/Mossy_Patchy_Ground_ihkcgdjzl_4k_Albedo-J-fP-FNu.jpg`,$u=`/Threejs-optimized-scene/assets/Mossy_Patchy_Ground_ihkcgdjzl_4k_AmbientOcclusion-BVt61QNE.jpg`,ed=`/Threejs-optimized-scene/assets/Mossy_Patchy_Ground_ihkcgdjzl_4k_Normal-BUEtUlz8.jpg`,td=`/Threejs-optimized-scene/assets/Mossy_Patchy_Ground_ihkcgdjzl_4k_Roughness-CFNEGmi9.jpg`,nd=Yu(),rd=-.18,id=190,ad=200,od=200,sd=18;function cd(e,t){let n=Math.sin(e*127.1+t*311.7)*43758.5453123;return n-Math.floor(n)}function ld(e,t){let n=Math.floor(e),r=Math.floor(t),i=e-n,a=t-r,o=cd(n,r),s=cd(n+1,r),c=cd(n,r+1),l=cd(n+1,r+1),u=i*i*(3-2*i),d=a*a*(3-2*a),f=o+(s-o)*u;return f+(c+(l-c)*u-f)*d}function ud(e,t){let n=0,r=.5,i=.03;for(let a=0;a<4;a+=1)n+=ld(e*i,t*i)*r,r*=.5,i*=2;return n}function dd(){let e=new Uint16Array(ad*od),t=id*.5;for(let n=0;n<od;n+=1)for(let r=0;r<ad;r+=1){let i=r/(ad-1),a=n/(od-1),o=-t+i*id,s=-t+a*id,c=Math.sin(o*.021+s*.006)*.21+Math.cos(s*.018-o*.007)*.19,l=(ud(o*.85,s*.85)-.5)*.52,u=(ud(o*2.1,s*2.1)-.5)*.14,d=Xu(42,94,Math.hypot(o,s))*.36,f=kt.clamp(.5+c+l+u+d,0,1);e[n*ad+r]=Math.round(f*65535)}return e}var fd=dd();function pd(e){return e/65535*sd-5.4}function md(e,t){let n=id*.5,r=(e+n)/id,i=(t+n)/id,a=kt.clamp(r,0,1),o=kt.clamp(i,0,1),s=a*(ad-1),c=o*(od-1),l=Math.floor(s),u=Math.floor(c),d=Math.min(l+1,ad-1),f=Math.min(u+1,od-1),p=s-l,m=c-u,h=pd(fd[u*ad+l]),g=pd(fd[u*ad+d]),_=pd(fd[f*ad+l]),v=pd(fd[f*ad+d]),y=kt.lerp(h,g,p),b=kt.lerp(_,v,p);return kt.lerp(y,b,m)}function hd(e,t){let n=md(e,t),r=Zu(nd,e,t,88);return n+-Math.exp(-(r*r)/(2*4.3**2))*1.75}function gd(e,t){return hd(e,t)+rd}function _d(e,t){e.wrapS=r,e.wrapT=r,e.repeat.set(t,t)}function vd(e,t){let n=new ba(id,id,ad-1,od-1);n.rotateX(-Math.PI/2);let r=n.attributes.position;for(let e=0;e<r.count;e+=1){let t=r.getX(e),n=r.getZ(e);r.setY(e,hd(t,n))}r.needsUpdate=!0,n.computeVertexNormals();let i=n.attributes.uv;n.setAttribute(`uv2`,new _r(i.array,2));let a=new po,o=a.load(Qu),s=a.load(ed),c=a.load(td),l=a.load($u),u=9.5;_d(o,u),_d(s,u),_d(c,u),_d(l,u),o.colorSpace=Be;let d=t?.capabilities?.getMaxAnisotropy?Math.min(8,t.capabilities.getMaxAnisotropy()):1;o.anisotropy=d,s.anisotropy=d,c.anisotropy=d,l.anisotropy=d;let f=new ti(n,new Na({map:o,normalMap:s,roughnessMap:c,aoMap:l,color:11053192,roughness:1,metalness:0,normalScale:new W(.7,.7),aoMapIntensity:.72}));return f.position.y=rd,f.receiveShadow=!1,e.add(f),{terrain:f,getTerrainHeight:gd}}var yd=`
uniform float uTime;
...
`;function xd(e,t,n=6.1,r=460){let i=[],a=[],o=[],s=(e,n)=>t(e,n)+.08;for(let t=0;t<=r;t+=1){let c=t/r,l=e.getPointAt(c),u=e.getTangentAt(c).normalize(),d=new G(-u.z,0,u.x).normalize(),f=.94+.08*Math.sin(c*Math.PI*2+.25),p=kt.lerp(.88,1,kt.smoothstep(c,0,.16)),m=kt.lerp(1,.74,kt.smoothstep(c,.88,1)),h=n*f*p*m,g=l.clone().addScaledVector(d,h),_=l.clone().addScaledVector(d,-h);if(g.y=s(g.x,g.z),_.y=s(_.x,_.z),i.push(g.x,g.y,g.z,_.x,_.y,_.z),a.push(0,c*7.5,1,c*7.5),t<r){let e=t*2;o.push(e,e+1,e+2,e+1,e+3,e+2)}}let c=new kr;return c.setAttribute(`position`,new _r(i,3)),c.setAttribute(`uv`,new _r(a,2)),c.setIndex(o),c.computeVertexNormals(),c}function Sd({isRiver:e,waveAmp:t,waveScale:n,flowDirection:r,shallow:i,deep:a,tint:o,reflectionTint:s,skyTop:c,skyHorizon:l}){return new ja({uniforms:{uTime:{value:0},uWaveAmp:{value:t},uWaveScale:{value:n},uIsRiver:{value:+!!e},uFlowDirection:{value:r.clone()},uColorShallow:{value:new Y(i)},uColorDeep:{value:new Y(a)},uWaterTint:{value:new Y(o)},uReflectionTint:{value:new Y(s)},uSkyTop:{value:new Y(c)},uSkyHorizon:{value:new Y(l)}},vertexShader:yd,fragmentShader:bd,transparent:!0,depthWrite:!1,side:2})}function Cd(e,t){let n=qu.clone();n.y=t(n.x,n.z)+.06;let r=Yu(),i=Sd({shallow:7194351,deep:2382981,tint:9358832,reflectionTint:15398911,skyTop:7850239,skyHorizon:12577023,isRiver:!0,waveAmp:.056,waveScale:.12,flowDirection:new W(.86,.2).normalize()}),a=new ti(xd(r,t,6.1,460),i);return e.add(a),{riverCurve:r,pondCenter:n,pondRadius:0,update(e){i.uniforms.uTime.value=e}}}function wd(e,t){if(t===0)return console.warn(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Geometry already defined as triangles.`),e;if(t===2||t===1){let n=e.getIndex();if(n===null){let t=[],r=e.getAttribute(`position`);if(r!==void 0){for(let e=0;e<r.count;e++)t.push(e);e.setIndex(t),n=e.getIndex()}else return console.error(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Undefined position attribute. Processing not possible.`),e}let r=n.count-2,i=[];if(t===2)for(let e=1;e<=r;e++)i.push(n.getX(0)),i.push(n.getX(e)),i.push(n.getX(e+1));else for(let e=0;e<r;e++)e%2==0?(i.push(n.getX(e)),i.push(n.getX(e+1)),i.push(n.getX(e+2))):(i.push(n.getX(e+2)),i.push(n.getX(e+1)),i.push(n.getX(e)));i.length/3!==r&&console.error(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unable to generate correct amount of triangles.`);let a=e.clone();return a.setIndex(i),a.clearGroups(),a}else return console.error(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unknown draw mode:`,t),e}function Td(e){let t=new Map,n=new Map,r=e.clone();return Ed(e,r,function(e,r){t.set(r,e),n.set(e,r)}),r.traverse(function(e){if(!e.isSkinnedMesh)return;let r=e,i=t.get(e),a=i.skeleton.bones;r.skeleton=i.skeleton.clone(),r.bindMatrix.copy(i.bindMatrix),r.skeleton.bones=a.map(function(e){return n.get(e)}),r.bind(r.skeleton,r.bindMatrix)}),r}function Ed(e,t,n){n(e,t);for(let r=0;r<e.children.length;r++)Ed(e.children[r],t.children[r],n)}var Dd=class extends oo{constructor(e){super(e),this.dracoLoader=null,this.ktx2Loader=null,this.meshoptDecoder=null,this.pluginCallbacks=[],this.register(function(e){return new Nd(e)}),this.register(function(e){return new Pd(e)}),this.register(function(e){return new Ud(e)}),this.register(function(e){return new Wd(e)}),this.register(function(e){return new Gd(e)}),this.register(function(e){return new Id(e)}),this.register(function(e){return new Ld(e)}),this.register(function(e){return new Rd(e)}),this.register(function(e){return new zd(e)}),this.register(function(e){return new Md(e)}),this.register(function(e){return new Bd(e)}),this.register(function(e){return new Fd(e)}),this.register(function(e){return new Hd(e)}),this.register(function(e){return new Vd(e)}),this.register(function(e){return new Ad(e)}),this.register(function(e){return new Kd(e,Q.EXT_MESHOPT_COMPRESSION)}),this.register(function(e){return new Kd(e,Q.KHR_MESHOPT_COMPRESSION)}),this.register(function(e){return new qd(e)})}load(e,t,n,r){let i=this,a;if(this.resourcePath!==``)a=this.resourcePath;else if(this.path!==``){let t=Io.extractUrlBase(e);a=Io.resolveURL(t,this.path)}else a=Io.extractUrlBase(e);this.manager.itemStart(e);let o=function(t){r?r(t):console.error(t),i.manager.itemError(e),i.manager.itemEnd(e)},s=new lo(this.manager);s.setPath(this.path),s.setResponseType(`arraybuffer`),s.setRequestHeader(this.requestHeader),s.setWithCredentials(this.withCredentials),s.load(e,function(n){try{i.parse(n,a,function(n){t(n),i.manager.itemEnd(e)},o)}catch(e){o(e)}},n,o)}setDRACOLoader(e){return this.dracoLoader=e,this}setKTX2Loader(e){return this.ktx2Loader=e,this}setMeshoptDecoder(e){return this.meshoptDecoder=e,this}register(e){return this.pluginCallbacks.indexOf(e)===-1&&this.pluginCallbacks.push(e),this}unregister(e){return this.pluginCallbacks.indexOf(e)!==-1&&this.pluginCallbacks.splice(this.pluginCallbacks.indexOf(e),1),this}parse(e,t,n,r){let i,a={},o={},s=new TextDecoder;if(typeof e==`string`)i=JSON.parse(e);else if(e instanceof ArrayBuffer)if(s.decode(new Uint8Array(e,0,4))===Jd){try{a[Q.KHR_BINARY_GLTF]=new Zd(e)}catch(e){r&&r(e);return}i=JSON.parse(a[Q.KHR_BINARY_GLTF].content)}else i=JSON.parse(s.decode(e));else i=e;if(i.asset===void 0||i.asset.version[0]<2){r&&r(Error(`THREE.GLTFLoader: Unsupported asset. glTF versions >=2.0 are supported.`));return}let c=new wf(i,{path:t||this.resourcePath||``,crossOrigin:this.crossOrigin,requestHeader:this.requestHeader,manager:this.manager,ktx2Loader:this.ktx2Loader,meshoptDecoder:this.meshoptDecoder});c.fileLoader.setRequestHeader(this.requestHeader);for(let e=0;e<this.pluginCallbacks.length;e++){let t=this.pluginCallbacks[e](c);t.name||console.error(`THREE.GLTFLoader: Invalid plugin found: missing name`),o[t.name]=t,a[t.name]=!0}if(i.extensionsUsed)for(let e=0;e<i.extensionsUsed.length;++e){let t=i.extensionsUsed[e],n=i.extensionsRequired||[];switch(t){case Q.KHR_MATERIALS_UNLIT:a[t]=new jd;break;case Q.KHR_DRACO_MESH_COMPRESSION:a[t]=new Qd(i,this.dracoLoader);break;case Q.KHR_TEXTURE_TRANSFORM:a[t]=new $d;break;case Q.KHR_MESH_QUANTIZATION:a[t]=new ef;break;default:n.indexOf(t)>=0&&o[t]===void 0&&console.warn(`THREE.GLTFLoader: Unknown extension "`+t+`".`)}}c.setExtensions(a),c.setPlugins(o),c.parse(n,r)}parseAsync(e,t){let n=this;return new Promise(function(r,i){n.parse(e,t,r,i)})}};function Od(){let e={};return{get:function(t){return e[t]},add:function(t,n){e[t]=n},remove:function(t){delete e[t]},removeAll:function(){e={}}}}function kd(e,t,n){let r=e.json.materials[t];return r.extensions&&r.extensions[n]?r.extensions[n]:null}var Q={KHR_BINARY_GLTF:`KHR_binary_glTF`,KHR_DRACO_MESH_COMPRESSION:`KHR_draco_mesh_compression`,KHR_LIGHTS_PUNCTUAL:`KHR_lights_punctual`,KHR_MATERIALS_CLEARCOAT:`KHR_materials_clearcoat`,KHR_MATERIALS_DISPERSION:`KHR_materials_dispersion`,KHR_MATERIALS_IOR:`KHR_materials_ior`,KHR_MATERIALS_SHEEN:`KHR_materials_sheen`,KHR_MATERIALS_SPECULAR:`KHR_materials_specular`,KHR_MATERIALS_TRANSMISSION:`KHR_materials_transmission`,KHR_MATERIALS_IRIDESCENCE:`KHR_materials_iridescence`,KHR_MATERIALS_ANISOTROPY:`KHR_materials_anisotropy`,KHR_MATERIALS_UNLIT:`KHR_materials_unlit`,KHR_MATERIALS_VOLUME:`KHR_materials_volume`,KHR_TEXTURE_BASISU:`KHR_texture_basisu`,KHR_TEXTURE_TRANSFORM:`KHR_texture_transform`,KHR_MESH_QUANTIZATION:`KHR_mesh_quantization`,KHR_MATERIALS_EMISSIVE_STRENGTH:`KHR_materials_emissive_strength`,EXT_MATERIALS_BUMP:`EXT_materials_bump`,EXT_TEXTURE_WEBP:`EXT_texture_webp`,EXT_TEXTURE_AVIF:`EXT_texture_avif`,EXT_MESHOPT_COMPRESSION:`EXT_meshopt_compression`,KHR_MESHOPT_COMPRESSION:`KHR_meshopt_compression`,EXT_MESH_GPU_INSTANCING:`EXT_mesh_gpu_instancing`},Ad=class{constructor(e){this.parser=e,this.name=Q.KHR_LIGHTS_PUNCTUAL,this.cache={refs:{},uses:{}}}_markDefs(){let e=this.parser,t=this.parser.json.nodes||[];for(let n=0,r=t.length;n<r;n++){let r=t[n];r.extensions&&r.extensions[this.name]&&r.extensions[this.name].light!==void 0&&e._addNodeRef(this.cache,r.extensions[this.name].light)}}_loadLight(e){let t=this.parser,n=`light:`+e,r=t.cache.get(n);if(r)return r;let i=t.json,a=((i.extensions&&i.extensions[this.name]||{}).lights||[])[e],o,s=new Y(16777215);a.color!==void 0&&s.setRGB(a.color[0],a.color[1],a.color[2],Ve);let c=a.range===void 0?0:a.range;switch(a.type){case`directional`:o=new Po(s),o.target.position.set(0,0,-1),o.add(o.target);break;case`point`:o=new jo(s),o.distance=c;break;case`spot`:o=new ko(s),o.distance=c,a.spot=a.spot||{},a.spot.innerConeAngle=a.spot.innerConeAngle===void 0?0:a.spot.innerConeAngle,a.spot.outerConeAngle=a.spot.outerConeAngle===void 0?Math.PI/4:a.spot.outerConeAngle,o.angle=a.spot.outerConeAngle,o.penumbra=1-a.spot.innerConeAngle/a.spot.outerConeAngle,o.target.position.set(0,0,-1),o.add(o.target);break;default:throw Error(`THREE.GLTFLoader: Unexpected light type: `+a.type)}return o.position.set(0,0,0),gf(o,a),a.intensity!==void 0&&(o.intensity=a.intensity),o.name=t.createUniqueName(a.name||`light_`+e),r=Promise.resolve(o),t.cache.add(n,r),r}getDependency(e,t){if(e===`light`)return this._loadLight(t)}createNodeAttachment(e){let t=this,n=this.parser,r=n.json.nodes[e],i=(r.extensions&&r.extensions[this.name]||{}).light;return i===void 0?null:this._loadLight(i).then(function(e){return n._getNodeRef(t.cache,i,e)})}},jd=class{constructor(){this.name=Q.KHR_MATERIALS_UNLIT}getMaterialType(){return Ur}extendParams(e,t,n){let r=[];e.color=new Y(1,1,1),e.opacity=1;let i=t.pbrMetallicRoughness;if(i){if(Array.isArray(i.baseColorFactor)){let t=i.baseColorFactor;e.color.setRGB(t[0],t[1],t[2],Ve),e.opacity=t[3]}i.baseColorTexture!==void 0&&r.push(n.assignTexture(e,`map`,i.baseColorTexture,Be))}return Promise.all(r)}},Md=class{constructor(e){this.parser=e,this.name=Q.KHR_MATERIALS_EMISSIVE_STRENGTH}extendMaterialParams(e,t){let n=kd(this.parser,e,this.name);return n===null||n.emissiveStrength!==void 0&&(t.emissiveIntensity=n.emissiveStrength),Promise.resolve()}},Nd=class{constructor(e){this.parser=e,this.name=Q.KHR_MATERIALS_CLEARCOAT}getMaterialType(e){return kd(this.parser,e,this.name)===null?null:Pa}extendMaterialParams(e,t){let n=kd(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];if(n.clearcoatFactor!==void 0&&(t.clearcoat=n.clearcoatFactor),n.clearcoatTexture!==void 0&&r.push(this.parser.assignTexture(t,`clearcoatMap`,n.clearcoatTexture)),n.clearcoatRoughnessFactor!==void 0&&(t.clearcoatRoughness=n.clearcoatRoughnessFactor),n.clearcoatRoughnessTexture!==void 0&&r.push(this.parser.assignTexture(t,`clearcoatRoughnessMap`,n.clearcoatRoughnessTexture)),n.clearcoatNormalTexture!==void 0&&(r.push(this.parser.assignTexture(t,`clearcoatNormalMap`,n.clearcoatNormalTexture)),n.clearcoatNormalTexture.scale!==void 0)){let e=n.clearcoatNormalTexture.scale;t.clearcoatNormalScale=new W(e,e)}return Promise.all(r)}},Pd=class{constructor(e){this.parser=e,this.name=Q.KHR_MATERIALS_DISPERSION}getMaterialType(e){return kd(this.parser,e,this.name)===null?null:Pa}extendMaterialParams(e,t){let n=kd(this.parser,e,this.name);return n===null||(t.dispersion=n.dispersion===void 0?0:n.dispersion),Promise.resolve()}},Fd=class{constructor(e){this.parser=e,this.name=Q.KHR_MATERIALS_IRIDESCENCE}getMaterialType(e){return kd(this.parser,e,this.name)===null?null:Pa}extendMaterialParams(e,t){let n=kd(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return n.iridescenceFactor!==void 0&&(t.iridescence=n.iridescenceFactor),n.iridescenceTexture!==void 0&&r.push(this.parser.assignTexture(t,`iridescenceMap`,n.iridescenceTexture)),n.iridescenceIor!==void 0&&(t.iridescenceIOR=n.iridescenceIor),t.iridescenceThicknessRange===void 0&&(t.iridescenceThicknessRange=[100,400]),n.iridescenceThicknessMinimum!==void 0&&(t.iridescenceThicknessRange[0]=n.iridescenceThicknessMinimum),n.iridescenceThicknessMaximum!==void 0&&(t.iridescenceThicknessRange[1]=n.iridescenceThicknessMaximum),n.iridescenceThicknessTexture!==void 0&&r.push(this.parser.assignTexture(t,`iridescenceThicknessMap`,n.iridescenceThicknessTexture)),Promise.all(r)}},Id=class{constructor(e){this.parser=e,this.name=Q.KHR_MATERIALS_SHEEN}getMaterialType(e){return kd(this.parser,e,this.name)===null?null:Pa}extendMaterialParams(e,t){let n=kd(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];if(t.sheenColor=new Y(0,0,0),t.sheenRoughness=0,t.sheen=1,n.sheenColorFactor!==void 0){let e=n.sheenColorFactor;t.sheenColor.setRGB(e[0],e[1],e[2],Ve)}return n.sheenRoughnessFactor!==void 0&&(t.sheenRoughness=n.sheenRoughnessFactor),n.sheenColorTexture!==void 0&&r.push(this.parser.assignTexture(t,`sheenColorMap`,n.sheenColorTexture,Be)),n.sheenRoughnessTexture!==void 0&&r.push(this.parser.assignTexture(t,`sheenRoughnessMap`,n.sheenRoughnessTexture)),Promise.all(r)}},Ld=class{constructor(e){this.parser=e,this.name=Q.KHR_MATERIALS_TRANSMISSION}getMaterialType(e){return kd(this.parser,e,this.name)===null?null:Pa}extendMaterialParams(e,t){let n=kd(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return n.transmissionFactor!==void 0&&(t.transmission=n.transmissionFactor),n.transmissionTexture!==void 0&&r.push(this.parser.assignTexture(t,`transmissionMap`,n.transmissionTexture)),Promise.all(r)}},Rd=class{constructor(e){this.parser=e,this.name=Q.KHR_MATERIALS_VOLUME}getMaterialType(e){return kd(this.parser,e,this.name)===null?null:Pa}extendMaterialParams(e,t){let n=kd(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];t.thickness=n.thicknessFactor===void 0?0:n.thicknessFactor,n.thicknessTexture!==void 0&&r.push(this.parser.assignTexture(t,`thicknessMap`,n.thicknessTexture)),t.attenuationDistance=n.attenuationDistance||1/0;let i=n.attenuationColor||[1,1,1];return t.attenuationColor=new Y().setRGB(i[0],i[1],i[2],Ve),Promise.all(r)}},zd=class{constructor(e){this.parser=e,this.name=Q.KHR_MATERIALS_IOR}getMaterialType(e){return kd(this.parser,e,this.name)===null?null:Pa}extendMaterialParams(e,t){let n=kd(this.parser,e,this.name);return n===null?Promise.resolve():(t.ior=n.ior===void 0?1.5:n.ior,t.ior===0&&(t.ior=1e3),Promise.resolve())}},Bd=class{constructor(e){this.parser=e,this.name=Q.KHR_MATERIALS_SPECULAR}getMaterialType(e){return kd(this.parser,e,this.name)===null?null:Pa}extendMaterialParams(e,t){let n=kd(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];t.specularIntensity=n.specularFactor===void 0?1:n.specularFactor,n.specularTexture!==void 0&&r.push(this.parser.assignTexture(t,`specularIntensityMap`,n.specularTexture));let i=n.specularColorFactor||[1,1,1];return t.specularColor=new Y().setRGB(i[0],i[1],i[2],Ve),n.specularColorTexture!==void 0&&r.push(this.parser.assignTexture(t,`specularColorMap`,n.specularColorTexture,Be)),Promise.all(r)}},Vd=class{constructor(e){this.parser=e,this.name=Q.EXT_MATERIALS_BUMP}getMaterialType(e){return kd(this.parser,e,this.name)===null?null:Pa}extendMaterialParams(e,t){let n=kd(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return t.bumpScale=n.bumpFactor===void 0?1:n.bumpFactor,n.bumpTexture!==void 0&&r.push(this.parser.assignTexture(t,`bumpMap`,n.bumpTexture)),Promise.all(r)}},Hd=class{constructor(e){this.parser=e,this.name=Q.KHR_MATERIALS_ANISOTROPY}getMaterialType(e){return kd(this.parser,e,this.name)===null?null:Pa}extendMaterialParams(e,t){let n=kd(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return n.anisotropyStrength!==void 0&&(t.anisotropy=n.anisotropyStrength),n.anisotropyRotation!==void 0&&(t.anisotropyRotation=n.anisotropyRotation),n.anisotropyTexture!==void 0&&r.push(this.parser.assignTexture(t,`anisotropyMap`,n.anisotropyTexture)),Promise.all(r)}},Ud=class{constructor(e){this.parser=e,this.name=Q.KHR_TEXTURE_BASISU}loadTexture(e){let t=this.parser,n=t.json,r=n.textures[e];if(!r.extensions||!r.extensions[this.name])return null;let i=r.extensions[this.name],a=t.options.ktx2Loader;if(!a){if(n.extensionsRequired&&n.extensionsRequired.indexOf(this.name)>=0)throw Error(`THREE.GLTFLoader: setKTX2Loader must be called before loading KTX2 textures`);return null}return t.loadTextureImage(e,i.source,a)}},Wd=class{constructor(e){this.parser=e,this.name=Q.EXT_TEXTURE_WEBP}loadTexture(e){let t=this.name,n=this.parser,r=n.json,i=r.textures[e];if(!i.extensions||!i.extensions[t])return null;let a=i.extensions[t],o=r.images[a.source],s=n.textureLoader;if(o.uri){let e=n.options.manager.getHandler(o.uri);e!==null&&(s=e)}return n.loadTextureImage(e,a.source,s)}},Gd=class{constructor(e){this.parser=e,this.name=Q.EXT_TEXTURE_AVIF}loadTexture(e){let t=this.name,n=this.parser,r=n.json,i=r.textures[e];if(!i.extensions||!i.extensions[t])return null;let a=i.extensions[t],o=r.images[a.source],s=n.textureLoader;if(o.uri){let e=n.options.manager.getHandler(o.uri);e!==null&&(s=e)}return n.loadTextureImage(e,a.source,s)}},Kd=class{constructor(e,t){this.name=t,this.parser=e}loadBufferView(e){let t=this.parser.json,n=t.bufferViews[e];if(n.extensions&&n.extensions[this.name]){let e=n.extensions[this.name],r=this.parser.getDependency(`buffer`,e.buffer),i=this.parser.options.meshoptDecoder;if(!i||!i.supported){if(t.extensionsRequired&&t.extensionsRequired.indexOf(this.name)>=0)throw Error(`THREE.GLTFLoader: setMeshoptDecoder must be called before loading compressed files`);return null}return r.then(function(t){let n=e.byteOffset||0,r=e.byteLength||0,a=e.count,o=e.byteStride,s=new Uint8Array(t,n,r);return i.decodeGltfBufferAsync?i.decodeGltfBufferAsync(a,o,s,e.mode,e.filter).then(function(e){return e.buffer}):i.ready.then(function(){let t=new ArrayBuffer(a*o);return i.decodeGltfBuffer(new Uint8Array(t),a,o,s,e.mode,e.filter),t})})}else return null}},qd=class{constructor(e){this.name=Q.EXT_MESH_GPU_INSTANCING,this.parser=e}createNodeMesh(e){let t=this.parser.json,n=t.nodes[e];if(!n.extensions||!n.extensions[this.name]||n.mesh===void 0)return null;let r=t.meshes[n.mesh];for(let e of r.primitives)if(e.mode!==af.TRIANGLES&&e.mode!==af.TRIANGLE_STRIP&&e.mode!==af.TRIANGLE_FAN&&e.mode!==void 0)return null;let i=n.extensions[this.name].attributes,a=[],o={};for(let e in i)a.push(this.parser.getDependency(`accessor`,i[e]).then(t=>(o[e]=t,o[e])));return a.length<1?null:(a.push(this.parser.createNodeMesh(e)),Promise.all(a).then(e=>{let t=e.pop(),n=t.isGroup?t.children:[t],r=e[0].count,i=[];for(let e of n){let t=new J,n=new G,a=new At,s=new G(1,1,1),c=new Di(e.geometry,e.material,r);for(let e=0;e<r;e++)o.TRANSLATION&&n.fromBufferAttribute(o.TRANSLATION,e),o.ROTATION&&a.fromBufferAttribute(o.ROTATION,e),o.SCALE&&s.fromBufferAttribute(o.SCALE,e),c.setMatrixAt(e,t.compose(n,a,s));for(let t in o)if(t===`_COLOR_0`){let e=o[t];c.instanceColor=new yi(e.array,e.itemSize,e.normalized)}else t!==`TRANSLATION`&&t!==`ROTATION`&&t!==`SCALE`&&e.geometry.setAttribute(t,o[t]);Tn.prototype.copy.call(c,e),this.parser.assignFinalMaterial(c),i.push(c)}return t.isGroup?(t.clear(),t.add(...i),t):i[0]}))}},Jd=`glTF`,Yd=12,Xd={JSON:1313821514,BIN:5130562},Zd=class{constructor(e){this.name=Q.KHR_BINARY_GLTF,this.content=null,this.body=null;let t=new DataView(e,0,Yd),n=new TextDecoder;if(this.header={magic:n.decode(new Uint8Array(e.slice(0,4))),version:t.getUint32(4,!0),length:t.getUint32(8,!0)},this.header.magic!==Jd)throw Error(`THREE.GLTFLoader: Unsupported glTF-Binary header.`);if(this.header.version<2)throw Error(`THREE.GLTFLoader: Legacy binary file detected.`);let r=this.header.length-Yd,i=new DataView(e,Yd),a=0;for(;a<r;){let t=i.getUint32(a,!0);a+=4;let r=i.getUint32(a,!0);if(a+=4,r===Xd.JSON){let r=new Uint8Array(e,Yd+a,t);this.content=n.decode(r)}else if(r===Xd.BIN){let n=Yd+a;this.body=e.slice(n,n+t)}a+=t}if(this.content===null)throw Error(`THREE.GLTFLoader: JSON content not found.`)}},Qd=class{constructor(e,t){if(!t)throw Error(`THREE.GLTFLoader: No DRACOLoader instance provided.`);this.name=Q.KHR_DRACO_MESH_COMPRESSION,this.json=e,this.dracoLoader=t,this.dracoLoader.preload()}decodePrimitive(e,t){let n=this.json,r=this.dracoLoader,i=e.extensions[this.name].bufferView,a=e.extensions[this.name].attributes,o={},s={},c={};for(let e in a){let t=uf[e]||e.toLowerCase();o[t]=a[e]}for(let t in e.attributes){let r=uf[t]||t.toLowerCase();if(a[t]!==void 0){let i=n.accessors[e.attributes[t]];c[r]=of[i.componentType].name,s[r]=i.normalized===!0}}return t.getDependency(`bufferView`,i).then(function(e){return new Promise(function(t,n){r.decodeDracoFile(e,function(e){for(let t in e.attributes){let n=e.attributes[t],r=s[t];r!==void 0&&(n.normalized=r)}t(e)},o,c,Ve,n)})})}},$d=class{constructor(){this.name=Q.KHR_TEXTURE_TRANSFORM}extendTexture(e,t){return(t.texCoord===void 0||t.texCoord===e.channel)&&t.offset===void 0&&t.rotation===void 0&&t.scale===void 0?e:(e=e.clone(),t.texCoord!==void 0&&(e.channel=t.texCoord),t.offset!==void 0&&e.offset.fromArray(t.offset),t.rotation!==void 0&&(e.rotation=t.rotation),t.scale!==void 0&&e.repeat.fromArray(t.scale),e.needsUpdate=!0,e)}},ef=class{constructor(){this.name=Q.KHR_MESH_QUANTIZATION}},tf=class extends Va{constructor(e,t,n,r){super(e,t,n,r)}copySampleValue_(e){let t=this.resultBuffer,n=this.sampleValues,r=this.valueSize,i=e*r*3+r;for(let e=0;e!==r;e++)t[e]=n[i+e];return t}interpolate_(e,t,n,r){let i=this.resultBuffer,a=this.sampleValues,o=this.valueSize,s=o*2,c=o*3,l=r-t,u=(n-t)/l,d=u*u,f=d*u,p=e*c,m=p-c,h=-2*f+3*d,g=f-d,_=1-h,v=g-d+u;for(let e=0;e!==o;e++){let t=a[m+e+o],n=a[m+e+s]*l,r=a[p+e+o],c=a[p+e]*l;i[e]=_*t+v*n+h*r+g*c}return i}},nf=new At,rf=class extends tf{interpolate_(e,t,n,r){let i=super.interpolate_(e,t,n,r);return nf.fromArray(i).normalize().toArray(i),i}},af={FLOAT:5126,FLOAT_MAT3:35675,FLOAT_MAT4:35676,FLOAT_VEC2:35664,FLOAT_VEC3:35665,FLOAT_VEC4:35666,LINEAR:9729,REPEAT:10497,SAMPLER_2D:35678,POINTS:0,LINES:1,LINE_LOOP:2,LINE_STRIP:3,TRIANGLES:4,TRIANGLE_STRIP:5,TRIANGLE_FAN:6,UNSIGNED_BYTE:5121,UNSIGNED_SHORT:5123},of={5120:Int8Array,5121:Uint8Array,5122:Int16Array,5123:Uint16Array,5125:Uint32Array,5126:Float32Array},sf={9728:o,9729:l,9984:s,9985:u,9986:c,9987:d},cf={33071:i,33648:a,10497:r},lf={SCALAR:1,VEC2:2,VEC3:3,VEC4:4,MAT2:4,MAT3:9,MAT4:16},uf={POSITION:`position`,NORMAL:`normal`,TANGENT:`tangent`,TEXCOORD_0:`uv`,TEXCOORD_1:`uv1`,TEXCOORD_2:`uv2`,TEXCOORD_3:`uv3`,COLOR_0:`color`,WEIGHTS_0:`skinWeight`,JOINTS_0:`skinIndex`},df={scale:`scale`,translation:`position`,rotation:`quaternion`,weights:`morphTargetInfluences`},ff={CUBICSPLINE:void 0,LINEAR:R,STEP:Ne},pf={OPAQUE:`OPAQUE`,MASK:`MASK`,BLEND:`BLEND`};function mf(e){return e.DefaultMaterial===void 0&&(e.DefaultMaterial=new Na({color:16777215,emissive:0,metalness:1,roughness:1,transparent:!1,depthTest:!0,side:0})),e.DefaultMaterial}function hf(e,t,n){for(let r in n.extensions)e[r]===void 0&&(t.userData.gltfExtensions=t.userData.gltfExtensions||{},t.userData.gltfExtensions[r]=n.extensions[r])}function gf(e,t){t.extras!==void 0&&(typeof t.extras==`object`?Object.assign(e.userData,t.extras):console.warn(`THREE.GLTFLoader: Ignoring primitive type .extras, `+t.extras))}function _f(e,t,n){let r=!1,i=!1,a=!1;for(let e=0,n=t.length;e<n;e++){let n=t[e];if(n.POSITION!==void 0&&(r=!0),n.NORMAL!==void 0&&(i=!0),n.COLOR_0!==void 0&&(a=!0),r&&i&&a)break}if(!r&&!i&&!a)return Promise.resolve(e);let o=[],s=[],c=[];for(let l=0,u=t.length;l<u;l++){let u=t[l];if(r){let t=u.POSITION===void 0?e.attributes.position:n.getDependency(`accessor`,u.POSITION);o.push(t)}if(i){let t=u.NORMAL===void 0?e.attributes.normal:n.getDependency(`accessor`,u.NORMAL);s.push(t)}if(a){let t=u.COLOR_0===void 0?e.attributes.color:n.getDependency(`accessor`,u.COLOR_0);c.push(t)}}return Promise.all([Promise.all(o),Promise.all(s),Promise.all(c)]).then(function(t){let n=t[0],o=t[1],s=t[2];return r&&(e.morphAttributes.position=n),i&&(e.morphAttributes.normal=o),a&&(e.morphAttributes.color=s),e.morphTargetsRelative=!0,e})}function vf(e,t){if(e.updateMorphTargets(),t.weights!==void 0)for(let n=0,r=t.weights.length;n<r;n++)e.morphTargetInfluences[n]=t.weights[n];if(t.extras&&Array.isArray(t.extras.targetNames)){let n=t.extras.targetNames;if(e.morphTargetInfluences.length===n.length){e.morphTargetDictionary={};for(let t=0,r=n.length;t<r;t++)e.morphTargetDictionary[n[t]]=t}else console.warn(`THREE.GLTFLoader: Invalid extras.targetNames length. Ignoring names.`)}}function yf(e){let t,n=e.extensions&&e.extensions[Q.KHR_DRACO_MESH_COMPRESSION];if(t=n?`draco:`+n.bufferView+`:`+n.indices+`:`+bf(n.attributes):e.indices+`:`+bf(e.attributes)+`:`+e.mode,e.targets!==void 0)for(let n=0,r=e.targets.length;n<r;n++)t+=`:`+bf(e.targets[n]);return t}function bf(e){let t=``,n=Object.keys(e).sort();for(let r=0,i=n.length;r<i;r++)t+=n[r]+`:`+e[n[r]]+`;`;return t}function xf(e){switch(e){case Int8Array:return 1/127;case Uint8Array:return 1/255;case Int16Array:return 1/32767;case Uint16Array:return 1/65535;default:throw Error(`THREE.GLTFLoader: Unsupported normalized accessor component type.`)}}function Sf(e){return e.search(/\.jpe?g($|\?)/i)>0||e.search(/^data\:image\/jpeg/)===0?`image/jpeg`:e.search(/\.webp($|\?)/i)>0||e.search(/^data\:image\/webp/)===0?`image/webp`:e.search(/\.ktx2($|\?)/i)>0||e.search(/^data\:image\/ktx2/)===0?`image/ktx2`:`image/png`}var Cf=new J,wf=class{constructor(e={},t={}){this.json=e,this.extensions={},this.plugins={},this.options=t,this.cache=new Od,this.associations=new Map,this.primitiveCache={},this.nodeCache={},this.meshCache={refs:{},uses:{}},this.cameraCache={refs:{},uses:{}},this.lightCache={refs:{},uses:{}},this.sourceCache={},this.textureCache={},this.nodeNamesUsed={};let n=!1,r=-1,i=!1,a=-1;if(typeof navigator<`u`&&navigator.userAgent!==void 0){let e=navigator.userAgent;n=/^((?!chrome|android).)*safari/i.test(e)===!0;let t=e.match(/Version\/(\d+)/);r=n&&t?parseInt(t[1],10):-1,i=e.indexOf(`Firefox`)>-1,a=i?e.match(/Firefox\/([0-9]+)\./)[1]:-1}typeof createImageBitmap>`u`||n&&r<17||i&&a<98?this.textureLoader=new po(this.options.manager):this.textureLoader=new Ro(this.options.manager),this.textureLoader.setCrossOrigin(this.options.crossOrigin),this.textureLoader.setRequestHeader(this.options.requestHeader),this.fileLoader=new lo(this.options.manager),this.fileLoader.setResponseType(`arraybuffer`),this.options.crossOrigin===`use-credentials`&&this.fileLoader.setWithCredentials(!0)}setExtensions(e){this.extensions=e}setPlugins(e){this.plugins=e}parse(e,t){let n=this,r=this.json,i=this.extensions;this.cache.removeAll(),this.nodeCache={},this._invokeAll(function(e){return e._markDefs&&e._markDefs()}),Promise.all(this._invokeAll(function(e){return e.beforeRoot&&e.beforeRoot()})).then(function(){return Promise.all([n.getDependencies(`scene`),n.getDependencies(`animation`),n.getDependencies(`camera`)])}).then(function(t){let a={scene:t[0][r.scene||0],scenes:t[0],animations:t[1],cameras:t[2],asset:r.asset,parser:n,userData:{}};return hf(i,a,r),gf(a,r),Promise.all(n._invokeAll(function(e){return e.afterRoot&&e.afterRoot(a)})).then(function(){for(let e of a.scenes)e.updateMatrixWorld();e(a)})}).catch(t)}_markDefs(){let e=this.json.nodes||[],t=this.json.skins||[],n=this.json.meshes||[];for(let n=0,r=t.length;n<r;n++){let r=t[n].joints;for(let t=0,n=r.length;t<n;t++)e[r[t]].isBone=!0}for(let t=0,r=e.length;t<r;t++){let r=e[t];r.mesh!==void 0&&(this._addNodeRef(this.meshCache,r.mesh),r.skin!==void 0&&(n[r.mesh].isSkinnedMesh=!0)),r.camera!==void 0&&this._addNodeRef(this.cameraCache,r.camera)}}_addNodeRef(e,t){t!==void 0&&(e.refs[t]===void 0&&(e.refs[t]=e.uses[t]=0),e.refs[t]++)}_getNodeRef(e,t,n){if(e.refs[t]<=1)return n;let r=n.clone(),i=(e,t)=>{let n=this.associations.get(e);n!=null&&this.associations.set(t,n);for(let[n,r]of e.children.entries())i(r,t.children[n])};return i(n,r),r.name+=`_instance_`+ e.uses[t]++,r}_invokeOne(e){let t=Object.values(this.plugins);t.push(this);for(let n=0;n<t.length;n++){let r=e(t[n]);if(r)return r}return null}_invokeAll(e){let t=Object.values(this.plugins);t.unshift(this);let n=[];for(let r=0;r<t.length;r++){let i=e(t[r]);i&&n.push(i)}return n}getDependency(e,t){let n=e+`:`+t,r=this.cache.get(n);if(!r){switch(e){case`scene`:r=this.loadScene(t);break;case`node`:r=this._invokeOne(function(e){return e.loadNode&&e.loadNode(t)});break;case`mesh`:r=this._invokeOne(function(e){return e.loadMesh&&e.loadMesh(t)});break;case`accessor`:r=this.loadAccessor(t);break;case`bufferView`:r=this._invokeOne(function(e){return e.loadBufferView&&e.loadBufferView(t)});break;case`buffer`:r=this.loadBuffer(t);break;case`material`:r=this._invokeOne(function(e){return e.loadMaterial&&e.loadMaterial(t)});break;case`texture`:r=this._invokeOne(function(e){return e.loadTexture&&e.loadTexture(t)});break;case`skin`:r=this.loadSkin(t);break;case`animation`:r=this._invokeOne(function(e){return e.loadAnimation&&e.loadAnimation(t)});break;case`camera`:r=this.loadCamera(t);break;default:if(r=this._invokeOne(function(n){return n!=this&&n.getDependency&&n.getDependency(e,t)}),!r)throw Error(`Unknown type: `+e);break}this.cache.add(n,r)}return r}getDependencies(e){let t=this.cache.get(e);if(!t){let n=this,r=this.json[e+(e===`mesh`?`es`:`s`)]||[];t=Promise.all(r.map(function(t,r){return n.getDependency(e,r)})),this.cache.add(e,t)}return t}loadBuffer(e){let t=this.json.buffers[e],n=this.fileLoader;if(t.type&&t.type!==`arraybuffer`)throw Error(`THREE.GLTFLoader: `+t.type+` buffer type is not supported.`);if(t.uri===void 0&&e===0)return Promise.resolve(this.extensions[Q.KHR_BINARY_GLTF].body);let r=this.options;return new Promise(function(e,i){n.load(Io.resolveURL(t.uri,r.path),e,void 0,function(){i(Error(`THREE.GLTFLoader: Failed to load buffer "`+t.uri+`".`))})})}loadBufferView(e){let t=this.json.bufferViews[e];return this.getDependency(`buffer`,t.buffer).then(function(e){let n=t.byteLength||0,r=t.byteOffset||0;return e.slice(r,r+n)})}loadAccessor(e){let t=this,n=this.json,r=this.json.accessors[e];if(r.bufferView===void 0&&r.sparse===void 0){let e=lf[r.type],t=of[r.componentType],n=r.normalized===!0,i=new t(r.count*e);return Promise.resolve(new mr(i,e,n))}let i=[];return r.bufferView===void 0?i.push(null):i.push(this.getDependency(`bufferView`,r.bufferView)),r.sparse!==void 0&&(i.push(this.getDependency(`bufferView`,r.sparse.indices.bufferView)),i.push(this.getDependency(`bufferView`,r.sparse.values.bufferView))),Promise.all(i).then(function(e){let i=e[0],a=lf[r.type],o=of[r.componentType],s=o.BYTES_PER_ELEMENT,c=s*a,l=r.byteOffset||0,u=r.bufferView===void 0?void 0:n.bufferViews[r.bufferView].byteStride,d=r.normalized===!0,f,p;if(u&&u!==c){let e=Math.floor(l/u),n=`InterleavedBuffer:`+r.bufferView+`:`+r.componentType+`:`+e+`:`+r.count,c=t.cache.get(n);c||(f=new o(i,e*u,r.count*u/s),c=new Ar(f,u/s),t.cache.add(n,c)),p=new Mr(c,a,l%u/s,d)}else f=i===null?new o(r.count*a):new o(i,l,r.count*a),p=new mr(f,a,d);if(r.sparse!==void 0){let t=lf.SCALAR,n=of[r.sparse.indices.componentType],s=r.sparse.indices.byteOffset||0,c=r.sparse.values.byteOffset||0,l=new n(e[1],s,r.sparse.count*t),u=new o(e[2],c,r.sparse.count*a);i!==null&&(p=new mr(p.array.slice(),p.itemSize,p.normalized)),p.normalized=!1;for(let e=0,t=l.length;e<t;e++){let t=l[e];if(p.setX(t,u[e*a]),a>=2&&p.setY(t,u[e*a+1]),a>=3&&p.setZ(t,u[e*a+2]),a>=4&&p.setW(t,u[e*a+3]),a>=5)throw Error(`THREE.GLTFLoader: Unsupported itemSize in sparse BufferAttribute.`)}p.normalized=d}return p})}loadTexture(e){let t=this.json,n=this.options,r=t.textures[e].source,i=t.images[r],a=this.textureLoader;if(i.uri){let e=n.manager.getHandler(i.uri);e!==null&&(a=e)}return this.loadTextureImage(e,r,a)}loadTextureImage(e,t,n){let r=this,i=this.json,a=i.textures[e],o=i.images[t],s=(o.uri||o.bufferView)+`:`+a.sampler;if(this.textureCache[s])return this.textureCache[s];let c=this.loadImageSource(t,n).then(function(t){t.flipY=!1,t.name=a.name||o.name||``,t.name===``&&typeof o.uri==`string`&&o.uri.startsWith(`data:image/`)===!1&&(t.name=o.uri);let n=(i.samplers||{})[a.sampler]||{};return t.magFilter=sf[n.magFilter]||1006,t.minFilter=sf[n.minFilter]||1008,t.wrapS=cf[n.wrapS]||1e3,t.wrapT=cf[n.wrapT]||1e3,t.generateMipmaps=!t.isCompressedTexture&&t.minFilter!==1003&&t.minFilter!==1006,r.associations.set(t,{textures:e}),t}).catch(function(){return null});return this.textureCache[s]=c,c}loadImageSource(e,t){let n=this,r=this.json,i=this.options;if(this.sourceCache[e]!==void 0)return this.sourceCache[e].then(e=>e.clone());let a=r.images[e],o=self.URL||self.webkitURL,s=a.uri||``,c=!1;if(a.bufferView!==void 0)s=n.getDependency(`bufferView`,a.bufferView).then(function(e){c=!0;let t=new Blob([e],{type:a.mimeType});return s=o.createObjectURL(t),s});else if(a.uri===void 0)throw Error(`THREE.GLTFLoader: Image `+e+` is missing URI and bufferView`);let l=Promise.resolve(s).then(function(e){return new Promise(function(n,r){let a=n;t.isImageBitmapLoader===!0&&(a=function(e){let t=new Kt(e);t.needsUpdate=!0,n(t)}),t.load(Io.resolveURL(e,i.path),a,void 0,r)})}).then(function(e){return c===!0&&o.revokeObjectURL(s),gf(e,a),e.userData.mimeType=a.mimeType||Sf(a.uri),e}).catch(function(e){throw console.error(`THREE.GLTFLoader: Couldn't load texture`,s),e});return this.sourceCache[e]=l,l}assignTexture(e,t,n,r){let i=this;return this.getDependency(`texture`,n.index).then(function(a){if(!a)return null;if(n.texCoord!==void 0&&n.texCoord>0&&(a=a.clone(),a.channel=n.texCoord),i.extensions[Q.KHR_TEXTURE_TRANSFORM]){let e=n.extensions===void 0?void 0:n.extensions[Q.KHR_TEXTURE_TRANSFORM];if(e){let t=i.associations.get(a);a=i.extensions[Q.KHR_TEXTURE_TRANSFORM].extendTexture(a,e),i.associations.set(a,t)}}return r!==void 0&&(a.colorSpace=r),e[t]=a,a})}assignFinalMaterial(e){let t=e.geometry,n=e.material,r=t.attributes.tangent===void 0,i=t.attributes.color!==void 0,a=t.attributes.normal===void 0;if(e.isPoints){let e=`PointsMaterial:`+n.uuid,t=this.cache.get(e);t||(t=new Xi,Pr.prototype.copy.call(t,n),t.color.copy(n.color),t.map=n.map,t.sizeAttenuation=!1,this.cache.add(e,t)),n=t}else if(e.isLine){let e=`LineBasicMaterial:`+n.uuid,t=this.cache.get(e);t||(t=new Ii,Pr.prototype.copy.call(t,n),t.color.copy(n.color),t.map=n.map,this.cache.add(e,t)),n=t}if(r||i||a){let e=`ClonedMaterial:`+n.uuid+`:`;r&&(e+=`derivative-tangents:`),i&&(e+=`vertex-colors:`),a&&(e+=`flat-shading:`);let t=this.cache.get(e);t||(t=n.clone(),i&&(t.vertexColors=!0),a&&(t.flatShading=!0),r&&(t.normalScale&&(t.normalScale.y*=-1),t.clearcoatNormalScale&&(t.clearcoatNormalScale.y*=-1)),this.cache.add(e,t),this.associations.set(t,this.associations.get(n))),n=t}e.material=n}getMaterialType(){return Na}loadMaterial(e){let t=this,n=this.json,r=this.extensions,i=n.materials[e],a,o={},s=i.extensions||{},c=[];if(s[Q.KHR_MATERIALS_UNLIT]){let e=r[Q.KHR_MATERIALS_UNLIT];a=e.getMaterialType(),c.push(e.extendParams(o,i,t))}else{let n=i.pbrMetallicRoughness||{};if(o.color=new Y(1,1,1),o.opacity=1,Array.isArray(n.baseColorFactor)){let e=n.baseColorFactor;o.color.setRGB(e[0],e[1],e[2],Ve),o.opacity=e[3]}n.baseColorTexture!==void 0&&c.push(t.assignTexture(o,`map`,n.baseColorTexture,Be)),o.metalness=n.metallicFactor===void 0?1:n.metallicFactor,o.roughness=n.roughnessFactor===void 0?1:n.roughnessFactor,n.metallicRoughnessTexture!==void 0&&(c.push(t.assignTexture(o,`metalnessMap`,n.metallicRoughnessTexture)),c.push(t.assignTexture(o,`roughnessMap`,n.metallicRoughnessTexture))),a=this._invokeOne(function(t){return t.getMaterialType&&t.getMaterialType(e)}),c.push(Promise.all(this._invokeAll(function(t){return t.extendMaterialParams&&t.extendMaterialParams(e,o)})))}i.doubleSided===!0&&(o.side=2);let l=i.alphaMode||pf.OPAQUE;if(l===pf.BLEND?(o.transparent=!0,o.depthWrite=!1):(o.transparent=!1,l===pf.MASK&&(o.alphaTest=i.alphaCutoff===void 0?.5:i.alphaCutoff)),i.normalTexture!==void 0&&a!==Ur&&(c.push(t.assignTexture(o,`normalMap`,i.normalTexture)),o.normalScale=new W(1,1),i.normalTexture.scale!==void 0)){let e=i.normalTexture.scale;o.normalScale.set(e,e)}if(i.occlusionTexture!==void 0&&a!==Ur&&(c.push(t.assignTexture(o,`aoMap`,i.occlusionTexture)),i.occlusionTexture.strength!==void 0&&(o.aoMapIntensity=i.occlusionTexture.strength)),i.emissiveFactor!==void 0&&a!==Ur){let e=i.emissiveFactor;o.emissive=new Y().setRGB(e[0],e[1],e[2],Ve)}return i.emissiveTexture!==void 0&&a!==Ur&&c.push(t.assignTexture(o,`emissiveMap`,i.emissiveTexture,Be)),Promise.all(c).then(function(){let n=new a(o);return i.name&&(n.name=i.name),gf(n,i),t.associations.set(n,{materials:e}),i.extensions&&hf(r,n,i),n})}createUniqueName(e){let t=ns.sanitizeNodeName(e||``);return t in this.nodeNamesUsed?t+`_`+ ++this.nodeNamesUsed[t]:(this.nodeNamesUsed[t]=0,t)}loadGeometries(e){let t=this,n=this.extensions,r=this.primitiveCache;function i(e){return n[Q.KHR_DRACO_MESH_COMPRESSION].decodePrimitive(e,t).then(function(n){return Ef(n,e,t)})}let a=[];for(let n=0,o=e.length;n<o;n++){let o=e[n],s=yf(o),c=r[s];if(c)a.push(c.promise);else{let e;e=o.extensions&&o.extensions[Q.KHR_DRACO_MESH_COMPRESSION]?i(o):Ef(new kr,o,t),r[s]={primitive:o,promise:e},a.push(e)}}return Promise.all(a)}loadMesh(e){let t=this,n=this.json,r=this.extensions,i=n.meshes[e],a=i.primitives,o=[];for(let e=0,t=a.length;e<t;e++){let t=a[e].material===void 0?mf(this.cache):this.getDependency(`material`,a[e].material);o.push(t)}return o.push(t.loadGeometries(a)),Promise.all(o).then(function(n){let o=n.slice(0,n.length-1),s=n[n.length-1],c=[];for(let n=0,l=s.length;n<l;n++){let l=s[n],u=a[n],d,f=o[n];if(u.mode===af.TRIANGLES||u.mode===af.TRIANGLE_STRIP||u.mode===af.TRIANGLE_FAN||u.mode===void 0)d=i.isSkinnedMesh===!0?new pi(l,f):new ti(l,f),d.isSkinnedMesh===!0&&d.normalizeSkinWeights(),u.mode===af.TRIANGLE_STRIP?d.geometry=wd(d.geometry,1):u.mode===af.TRIANGLE_FAN&&(d.geometry=wd(d.geometry,2));else if(u.mode===af.LINES)d=new Ji(l,f);else if(u.mode===af.LINE_STRIP)d=new Wi(l,f);else if(u.mode===af.LINE_LOOP)d=new Yi(l,f);else if(u.mode===af.POINTS)d=new ta(l,f);else throw Error(`THREE.GLTFLoader: Primitive mode unsupported: `+u.mode);Object.keys(d.geometry.morphAttributes).length>0&&vf(d,i),d.name=t.createUniqueName(i.name||`mesh_`+e),gf(d,i),u.extensions&&hf(r,d,u),t.assignFinalMaterial(d),c.push(d)}for(let n=0,r=c.length;n<r;n++)t.associations.set(c[n],{meshes:e,primitives:n});if(c.length===1)return i.extensions&&hf(r,c[0],i),c[0];let l=new En;i.extensions&&hf(r,l,i),t.associations.set(l,{meshes:e});for(let e=0,t=c.length;e<t;e++)l.add(c[e]);return l})}loadCamera(e){let t,n=this.json.cameras[e],r=n[n.type];if(!r){console.warn(`THREE.GLTFLoader: Missing camera parameters.`);return}return n.type===`perspective`?t=new Do(kt.radToDeg(r.yfov),r.aspectRatio||1,r.znear||1,r.zfar||2e6):n.type===`orthographic`&&(t=new Mo(-r.xmag,r.xmag,r.ymag,-r.ymag,r.znear,r.zfar)),n.name&&(t.name=this.createUniqueName(n.name)),gf(t,n),Promise.resolve(t)}loadSkin(e){let t=this.json.skins[e],n=[];for(let e=0,r=t.joints.length;e<r;e++)n.push(this._loadNodeShallow(t.joints[e]));return t.inverseBindMatrices===void 0?n.push(null):n.push(this.getDependency(`accessor`,t.inverseBindMatrices)),Promise.all(n).then(function(e){let n=e.pop(),r=e,i=[],a=[];for(let e=0,o=r.length;e<o;e++){let o=r[e];if(o){i.push(o);let t=new J;n!==null&&t.fromArray(n.array,e*16),a.push(t)}else console.warn(`THREE.GLTFLoader: Joint "%s" could not be found.`,t.joints[e])}return new vi(i,a)})}loadAnimation(e){let t=this.json,n=this,r=t.animations[e],i=r.name?r.name:`animation_`+e,a=[],o=[],s=[],c=[],l=[];for(let e=0,t=r.channels.length;e<t;e++){let t=r.channels[e],n=r.samplers[t.sampler],i=t.target,u=i.node,d=r.parameters===void 0?n.input:r.parameters[n.input],f=r.parameters===void 0?n.output:r.parameters[n.output];i.node!==void 0&&(a.push(this.getDependency(`node`,u)),o.push(this.getDependency(`accessor`,d)),s.push(this.getDependency(`accessor`,f)),c.push(n),l.push(i))}return Promise.all([Promise.all(a),Promise.all(o),Promise.all(s),Promise.all(c),Promise.all(l)]).then(function(e){let t=e[0],a=e[1],o=e[2],s=e[3],c=e[4],l=[];for(let e=0,r=t.length;e<r;e++){let r=t[e],i=a[e],u=o[e],d=s[e],f=c[e];if(r===void 0)continue;r.updateMatrix&&r.updateMatrix();let p=n._createAnimationTracks(r,i,u,d,f);if(p)for(let e=0;e<p.length;e++)l.push(p[e])}let u=new eo(i,void 0,l);return gf(u,r),u})}createNodeMesh(e){let t=this.json,n=this,r=t.nodes[e];return r.mesh===void 0?null:n.getDependency(`mesh`,r.mesh).then(function(e){let t=n._getNodeRef(n.meshCache,r.mesh,e);return r.weights!==void 0&&t.traverse(function(e){if(e.isMesh)for(let t=0,n=r.weights.length;t<n;t++)e.morphTargetInfluences[t]=r.weights[t]}),t})}loadNode(e){let t=this.json,n=this,r=t.nodes[e],i=n._loadNodeShallow(e),a=[],o=r.children||[];for(let e=0,t=o.length;e<t;e++)a.push(n.getDependency(`node`,o[e]));let s=r.skin===void 0?Promise.resolve(null):n.getDependency(`skin`,r.skin);return Promise.all([i,Promise.all(a),s]).then(function(e){let t=e[0],n=e[1],r=e[2];r!==null&&t.traverse(function(e){e.isSkinnedMesh&&e.bind(r,Cf)});for(let e=0,r=n.length;e<r;e++)t.add(n[e]);if(t.userData.pivot!==void 0&&n.length>0){let e=t.userData.pivot,r=n[0];t.pivot=new G().fromArray(e),t.position.x-=e[0],t.position.y-=e[1],t.position.z-=e[2],r.position.set(0,0,0),delete t.userData.pivot}return t})}_loadNodeShallow(e){let t=this.json,n=this.extensions,r=this;if(this.nodeCache[e]!==void 0)return this.nodeCache[e];let i=t.nodes[e],a=i.name?r.createUniqueName(i.name):``,o=[],s=r._invokeOne(function(t){return t.createNodeMesh&&t.createNodeMesh(e)});return s&&o.push(s),i.camera!==void 0&&o.push(r.getDependency(`camera`,i.camera).then(function(e){return r._getNodeRef(r.cameraCache,i.camera,e)})),r._invokeAll(function(t){return t.createNodeAttachment&&t.createNodeAttachment(e)}).forEach(function(e){o.push(e)}),this.nodeCache[e]=Promise.all(o).then(function(t){let o;if(o=i.isBone===!0?new mi:t.length>1?new En:t.length===1?t[0]:new Tn,o!==t[0])for(let e=0,n=t.length;e<n;e++)o.add(t[e]);if(i.name&&(o.userData.name=i.name,o.name=a),gf(o,i),i.extensions&&hf(n,o,i),i.matrix!==void 0){let e=new J;e.fromArray(i.matrix),o.applyMatrix4(e)}else i.translation!==void 0&&o.position.fromArray(i.translation),i.rotation!==void 0&&o.quaternion.fromArray(i.rotation),i.scale!==void 0&&o.scale.fromArray(i.scale);if(!r.associations.has(o))r.associations.set(o,{});else if(i.mesh!==void 0&&r.meshCache.refs[i.mesh]>1){let e=r.associations.get(o);r.associations.set(o,{...e})}return r.associations.get(o).nodes=e,o}),this.nodeCache[e]}loadScene(e){let t=this.extensions,n=this.json.scenes[e],r=this,i=new En;n.name&&(i.name=r.createUniqueName(n.name)),gf(i,n),n.extensions&&hf(t,i,n);let a=n.nodes||[],o=[];for(let e=0,t=a.length;e<t;e++)o.push(r.getDependency(`node`,a[e]));return Promise.all(o).then(function(e){for(let t=0,n=e.length;t<n;t++){let n=e[t];n.parent===null?i.add(n):i.add(Td(n))}return r.associations=(e=>{let t=new Map;for(let[e,n]of r.associations)(e instanceof Pr||e instanceof Kt)&&t.set(e,n);return e.traverse(e=>{let n=r.associations.get(e);n!=null&&t.set(e,n)}),t})(i),i})}_createAnimationTracks(e,t,n,r,i){let a=[],o=e.name?e.name:e.uuid,s=[];function c(e){e.morphTargetInfluences&&s.push(e.name?e.name:e.uuid)}df[i.path]===df.weights?(c(e),e.isGroup&&e.children.forEach(c)):s.push(o);let l;switch(df[i.path]){case df.weights:l=Ya;break;case df.rotation:l=Za;break;case df.translation:case df.scale:l=$a;break;default:switch(n.itemSize){case 1:l=Ya;break;default:l=$a;break}break}let u=r.interpolation===void 0?R:ff[r.interpolation],d=this._getArrayFromAccessor(n);for(let e=0,n=s.length;e<n;e++){let n=new l(s[e]+`.`+df[i.path],t.array,d,u);r.interpolation===`CUBICSPLINE`&&this._createCubicSplineTrackInterpolant(n),a.push(n)}return a}_getArrayFromAccessor(e){let t=e.array;if(e.normalized){let e=xf(t.constructor),n=new Float32Array(t.length);for(let r=0,i=t.length;r<i;r++)n[r]=t[r]*e;t=n}return t}_createCubicSplineTrackInterpolant(e){e.createInterpolant=function(e){return new(this instanceof Za?rf:tf)(this.times,this.values,this.getValueSize()/3,e)},e.createInterpolant.isInterpolantFactoryMethodGLTFCubicSpline=!0}};function Tf(e,t,n){let r=t.attributes,i=new Xn;if(r.POSITION!==void 0){let e=n.json.accessors[r.POSITION],t=e.min,a=e.max;if(t!==void 0&&a!==void 0){if(i.set(new G(t[0],t[1],t[2]),new G(a[0],a[1],a[2])),e.normalized){let t=xf(of[e.componentType]);i.min.multiplyScalar(t),i.max.multiplyScalar(t)}}else{console.warn(`THREE.GLTFLoader: Missing min/max properties for accessor POSITION.`);return}}else return;let a=t.targets;if(a!==void 0){let e=new G,t=new G;for(let r=0,i=a.length;r<i;r++){let i=a[r];if(i.POSITION!==void 0){let r=n.json.accessors[i.POSITION],a=r.min,o=r.max;if(a!==void 0&&o!==void 0){if(t.setX(Math.max(Math.abs(a[0]),Math.abs(o[0]))),t.setY(Math.max(Math.abs(a[1]),Math.abs(o[1]))),t.setZ(Math.max(Math.abs(a[2]),Math.abs(o[2]))),r.normalized){let e=xf(of[r.componentType]);t.multiplyScalar(e)}e.max(t)}else console.warn(`THREE.GLTFLoader: Missing min/max properties for accessor POSITION.`)}}i.expandByVector(e)}e.boundingBox=i;let o=new xr;i.getCenter(o.center),o.radius=i.min.distanceTo(i.max)/2,e.boundingSphere=o}function Ef(e,t,n){let r=t.attributes,i=[];function a(t,r){return n.getDependency(`accessor`,t).then(function(t){e.setAttribute(r,t)})}for(let t in r){let n=uf[t]||t.toLowerCase();n in e.attributes||i.push(a(r[t],n))}if(t.indices!==void 0&&!e.index){let r=n.getDependency(`accessor`,t.indices).then(function(t){e.setIndex(t)});i.push(r)}return q.workingColorSpace!==`srgb-linear`&&`COLOR_0`in r&&console.warn(`THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${q.workingColorSpace}" not supported.`),gf(e,t),Tf(e,t,n),Promise.all(i).then(function(){return t.targets===void 0?e:_f(e,t.targets,n)})}var Df=new Yn,Of=new G,kf=new W,Af=new W,jf=new W,Mf=class{constructor(e){this.geometry=e.geometry,this.randomFunction=Math.random,this.indexAttribute=this.geometry.index,this.positionAttribute=this.geometry.getAttribute(`position`),this.normalAttribute=this.geometry.getAttribute(`normal`),this.colorAttribute=this.geometry.getAttribute(`color`),this.uvAttribute=this.geometry.getAttribute(`uv`),this.weightAttribute=null,this.distribution=null}setWeightAttribute(e){return this.weightAttribute=e?this.geometry.getAttribute(e):null,this}build(){let e=this.indexAttribute,t=this.positionAttribute,n=this.weightAttribute,r=e?e.count/3:t.count/3,i=new Float32Array(r);for(let a=0;a<r;a++){let r=1,o=3*a,s=3*a+1,c=3*a+2;e&&(o=e.getX(o),s=e.getX(s),c=e.getX(c)),n&&(r=n.getX(o)+n.getX(s)+n.getX(c)),Df.a.fromBufferAttribute(t,o),Df.b.fromBufferAttribute(t,s),Df.c.fromBufferAttribute(t,c),r*=Df.getArea(),i[a]=r}let a=new Float32Array(r),o=0;for(let e=0;e<r;e++)o+=i[e],a[e]=o;return this.distribution=a,this}setRandomGenerator(e){return this.randomFunction=e,this}sample(e,t,n,r){let i=this._sampleFaceIndex();return this._sampleFace(i,e,t,n,r)}_sampleFaceIndex(){let e=this.distribution[this.distribution.length-1];return this._binarySearch(this.randomFunction()*e)}_binarySearch(e){let t=this.distribution,n=0,r=t.length-1,i=-1;for(;n<=r;){let a=Math.ceil((n+r)/2);if(a===0||t[a-1]<=e&&t[a]>e){i=a;break}else e<t[a]?r=a-1:n=a+1}return i}_sampleFace(e,t,n,r,i){let a=this.randomFunction(),o=this.randomFunction();a+o>1&&(a=1-a,o=1-o);let s=this.indexAttribute,c=e*3,l=e*3+1,u=e*3+2;return s&&(c=s.getX(c),l=s.getX(l),u=s.getX(u)),Df.a.fromBufferAttribute(this.positionAttribute,c),Df.b.fromBufferAttribute(this.positionAttribute,l),Df.c.fromBufferAttribute(this.positionAttribute,u),t.set(0,0,0).addScaledVector(Df.a,a).addScaledVector(Df.b,o).addScaledVector(Df.c,1-(a+o)),n!==void 0&&(this.normalAttribute===void 0?Df.getNormal(n):(Df.a.fromBufferAttribute(this.normalAttribute,c),Df.b.fromBufferAttribute(this.normalAttribute,l),Df.c.fromBufferAttribute(this.normalAttribute,u),n.set(0,0,0).addScaledVector(Df.a,a).addScaledVector(Df.b,o).addScaledVector(Df.c,1-(a+o)).normalize())),r!==void 0&&this.colorAttribute!==void 0&&(Df.a.fromBufferAttribute(this.colorAttribute,c),Df.b.fromBufferAttribute(this.colorAttribute,l),Df.c.fromBufferAttribute(this.colorAttribute,u),Of.set(0,0,0).addScaledVector(Df.a,a).addScaledVector(Df.b,o).addScaledVector(Df.c,1-(a+o)),r.r=Of.x,r.g=Of.y,r.b=Of.z),i!==void 0&&this.uvAttribute!==void 0&&(kf.fromBufferAttribute(this.uvAttribute,c),Af.fromBufferAttribute(this.uvAttribute,l),jf.fromBufferAttribute(this.uvAttribute,u),i.set(0,0).addScaledVector(kf,a).addScaledVector(Af,o).addScaledVector(jf,1-(a+o))),this}},Nf={eyeHeight:2.28,moveSpeed:7.4,strafeSpeed:6.8,maxSlopeStep:.24,minFov:30,maxFov:78,zoomStepWheel:1.6,zoomStepKey:20},Pf={trees:{totalCount:860,edgeInner:66,edgeOuter:88,nearRiverOffsetMin:13,nearRiverOffsetMax:22,centerExclusionRadius:24,impostorStartRadius:70,impostorRatio:.6},flowers:{count:980,riverOffsetMin:4.8,riverOffsetMax:11.4,pondRingMin:3.4,pondRingMax:8.6},grass:{riverBankCount:2200,meadowCount:4800,riverOffsetMin:4.2,riverOffsetMax:11.2,pondRingMin:2.2,pondRingMax:8.4,meadowRadius:88,lodNearDistance:24,lodMidDistance:44,lodFarDistance:66,lodMidStride:4,lodFarStride:12,lodUpdateInterval:.3},waterExclusion:{pondPadding:0,riverWidth:5.8}},Ff=new G(0,1,0),If={x:-59.27,z:-6.24,targetHeight:4.3,yaw:Math.PI*.22},Lf={x:-54.46,z:-.55,targetHeight:1.6,yaw:Math.PI*.1},Rf={x:(If.x+Lf.x)*.5,z:(If.z+Lf.z)*.5,radius:2.15};function zf(e,t,n,r=.7){let i=e(t+r,n),a=e(t-r,n),o=e(t,n+r),s=e(t,n-r);return new G(a-i,r*2,s-o).normalize()}function Bf(e,t,n,r){t.updateMatrixWorld(!0);let i=new Xn().setFromObject(t),a=new G;i.getSize(a);let o=Math.max(.001,a.y),s=n.targetHeight/o;t.scale.setScalar(s),t.updateMatrixWorld(!0);let c=new Xn().setFromObject(t).min.y,l=r(n.x,n.z),u=zf(r,n.x,n.z);return e.position.set(n.x,l,n.z),e.quaternion.setFromUnitVectors(Ff,u),e.rotation.y+=n.yaw,t.position.set(0,-c+.01,0),e.add(t),e.updateMatrixWorld(!0),e.matrixAutoUpdate=!1,t.matrixAutoUpdate=!1,{x:n.x,y:l,z:n.z,scale:s}}function Vf(e,t){return new Promise((n,r)=>{e.load(t,e=>n(e.scene),void 0,e=>r(e))})}function Hf(){let e=new En,t=new ti(new ua(1.8,3.4,6),new Ur({color:12559995}));return t.rotation.z=Math.PI*.5,e.add(t),e}function Uf(){let e=new En,t=new ti(new la(.8,1,.5,10),new Ur({color:7293487})),n=new ti(new ua(.7,1.8,8),new Ur({color:16750899}));return n.position.y=1,e.add(t,n),e}async function Wf(e,t){let n=new Dd,[r,i]=await Promise.all([Vf(n,`/tent_xyz.glb`).catch(e=>(console.warn(`Tent model failed to load, using fallback tent`,e),Hf())),Vf(n,`/bonfire_and_pot.glb`).catch(e=>(console.warn(`Bonfire model failed to load, using fallback bonfire`,e),Uf()))]),a=new En,o=new En;r.traverse(e=>{e.isMesh&&(e.castShadow=!1,e.receiveShadow=!1)}),i.traverse(e=>{e.isMesh&&(e.castShadow=!1,e.receiveShadow=!1)});let s=Bf(a,r,If,t),c=Bf(o,i,Lf,t);return e.add(a),e.add(o),console.info(`Camp props loaded`,{tentPlacement:s,bonfirePlacement:c}),{tent:a,bonfire:o}}var Gf=`/Threejs-optimized-scene/assets/color-CoNErV-7.webp`,Kf=`/Threejs-optimized-scene/assets/normal-krnp92yS.webp`,qf=`/Threejs-optimized-scene/assets/rmao-BPE7iMyQ.webp`,Jf=`/Threejs-optimized-scene/assets/BaseColor-Cau1Np30.webp`,Yf=`/Threejs-optimized-scene/assets/Normal-DsV9lSkh.webp`,Xf=`/Threejs-optimized-scene/assets/OcclusionRoughnessMetallic-DNp92MuX.webp`,$=new Tn,Zf=new G,Qf=new G(0,1,0),$f=new G,ep=new At,tp=new At,np=new po,rp=new is,ip=new G,ap=new G(0,-1,0),op=new WeakMap,sp=[{name:`tree-stylized-01`,targetHeight:11,meshNames:[`tree-stylized-01_tree-branch-stylized-diffuse_0`,`tree-stylized-01_tree-wood_0`]},{name:`tree-stylized-02-dry`,targetHeight:10.2,meshNames:[`tree-stylized-02-dry_tree-bark-02_0`,`tree-stylized-02-dry_tree-branches-dry-diffuse_0`]},{name:`tree-stylized-03-autumn-yellow`,targetHeight:10.8,meshNames:[`tree-stylized-03-autumn-yellow_tree-branches-autumn-yellow-mix-diffuse_0`,`tree-stylized-03-autumn-yellow_tree-bark-03_0`]},{name:`tree-stylized-04-green`,targetHeight:11.2,meshNames:[`tree-stylized-04-green_tree-04_0`,`tree-stylized-04-green_tree-branches-mix-diffuse_0`]},{name:`tree-stylized-05-autumn-brown`,targetHeight:11,meshNames:[`tree-stylized-05-autumn-brown_tree-branches-autumn-mix-diffuse_0`,`tree-stylized-05-autumn-brown_tree-bark-03_0`]}],cp=[{name:`daisy-01`,targetHeight:.72,meshNames:[`daisy-flower-diffuse-01_daisy-flower-diffuse_0`,`daisy-flower-diffuse-01_daisy-stem-diffuse_0`]},{name:`daisy-02`,targetHeight:.72,meshNames:[`daisy-flower-diffuse-02_daisy-flower-diffuse_0`,`daisy-flower-diffuse-02_daisy-stem-diffuse_0`]},{name:`daisy-03`,targetHeight:.72,meshNames:[`daisy-flower-diffuse-03_daisy-flower-diffuse_0`,`daisy-flower-diffuse-03_daisy-stem-diffuse-02_0`]},{name:`daffodil-01`,targetHeight:.78,meshNames:[`daffodil-flower-01_daffodil-stem-01-diffuse_0`,`daffodil-flower-01_daffodil-flower-yellow_0`]},{name:`daffodil-02`,targetHeight:.78,meshNames:[`daffodil-flower-02_daffodil-flower-white_0`,`daffodil-flower-02_daffodil-stem-02-diffuse_0`]}];function lp(e,t=!1){e.wrapS=r,e.wrapT=r,t&&(e.colorSpace=Be)}function up(e,t,n,r=.44){let i=np.load(e);return lp(i,!0),new Ur({map:i,color:16777215,transparent:!1,alphaTest:r,side:2,depthWrite:!0,depthTest:!0,fog:!0,toneMapped:!1})}function dp(e,t){return Array.isArray(e)&&e.length>0?e[0].clone():e?e.clone():new Na({color:t,roughness:.9,metalness:.02})}function fp(e,t){let n=e.geometry.clone();return n.applyMatrix4(e.matrixWorld),n.computeBoundingBox(),{geometry:n,material:dp(e.material,t)}}function pp(e){let t=new Xn,n=!1;for(let r of e)if(r.geometry.boundingBox||r.geometry.computeBoundingBox(),r.geometry.boundingBox){if(!n){t.copy(r.geometry.boundingBox),n=!0;continue}t.union(r.geometry.boundingBox)}return{initialized:n,box:t}}function mp(e){let t=pp(e);if(!t.initialized)return;let n=(t.box.min.x+t.box.max.x)*.5,r=(t.box.min.z+t.box.max.z)*.5,i=-t.box.min.y;for(let t of e)t.geometry.translate(-n,i,-r),t.geometry.computeBoundingBox()}function hp(e){let t=pp(e);return t.initialized?(t.box.getSize(Zf),Math.max(.001,Zf.y)):1}function gp(e,t,n){let r=[];for(let i of t){let t=i.meshNames.map(t=>e.get(t)).filter(e=>!!e);if(t.length===0)continue;let a=t.map(e=>fp(e,n));mp(a);let o=hp(a),s=i.targetHeight/o;r.push({name:i.name,parts:a,baseScale:s})}return r}function _p(e){return e===`trees`?[{name:`fallback-tree`,baseScale:1,parts:[{geometry:new ua(.95,7.8,8),material:new Na({color:5078341,roughness:.92,metalness:.03})}]}]:e===`flowers`?[{name:`fallback-flower`,baseScale:1,parts:[{geometry:new Sa(.2,0),material:new Na({color:16748473,roughness:.86,metalness:.01})}]}]:[{name:`fallback-grass`,baseScale:1,parts:[{geometry:new ua(.15,.95,5),material:new Na({color:6662482,roughness:1,metalness:0})}]}]}function vp(e=66,t=88){let n=Math.random()*Math.PI*2,r=e+Math.random()*(t-e);return new G(Math.cos(n)*r,0,Math.sin(n)*r)}function yp(e,t,n){let r=Math.random(),i=e.getPointAt(r),a=e.getTangentAt(r).normalize(),o=new G(-a.z,0,a.x).normalize(),s=Math.random()<.5?-1:1,c=t+Math.random()*(n-t);return new G(i.x+o.x*c*s+(Math.random()-.5)*1.2,0,i.z+o.z*c*s+(Math.random()-.5)*1.2)}function bp(e,t,n,r){let i=Math.random()*Math.PI*2,a=t+n+Math.random()*(r-n);return new G(e.x+Math.cos(i)*a,0,e.z+Math.sin(i)*a)}function xp(e,t){if(!e)return t.clone();ip.set(t.x,120,t.z),rp.set(ip,ap);let n=rp.intersectObject(e,!1)[0];return n?n.point.clone():t.clone()}function Sp(e){if(!e)return null;if(op.has(e))return op.get(e);let t=new Mf(e).build();return op.set(e,t),t}function Cp(e,t,n){return e?(e.sample(t,n),!0):!1}function wp({terrainSampler:e,riverSamples:t,pondCenter:n,pondRadius:r,minRiverDistance:i,maxRiverDistance:a,targetPosition:o,targetNormal:s,maxAttempts:c=28}){if(!e)return!1;for(let l=0;l<c;l+=1){if(Cp(e,o,s),Op(o.x,o.z,t,n,r))continue;let c=Dp(o.x,o.z,t);if(!(c<i||c>a))return!0}return!1}function Tp(e,t=96){let n=[];for(let r=0;r<=t;r+=1)n.push(e.getPointAt(r/t));return n}function Ep(e,t,n,r,i,a){let o=i-n,s=a-r,c=e-n,l=t-r,u=o*o+s*s,d=u>0?Math.max(0,Math.min(1,(c*o+l*s)/u)):0,f=n+o*d,p=r+s*d;return Math.hypot(e-f,t-p)}function Dp(e,t,n){let r=1/0;for(let i=0;i<n.length-1;i+=1){let a=n[i],o=n[i+1],s=Ep(e,t,a.x,a.z,o.x,o.z);s<r&&(r=s)}return r}function Op(e,t,n,r,i){return i>.01&&Math.hypot(e-r.x,t-r.z)<i+Pf.waterExclusion.pondPadding?!0:Dp(e,t,n)<Pf.waterExclusion.riverWidth}function kp(e,t){if(!Rf)return!1;let n=e-Rf.x,r=t-Rf.z;return n*n+r*r<Rf.radius*Rf.radius}function Ap(e,t,n,r,i,a,o){let s=Pf.grass,c=Math.floor(s.riverBankCount*.7)+Math.floor(s.meadowCount*.72),l=Math.max(120,Math.floor(s.riverBankCount*.12)),u=Sp(o),d=new G,f=new G,p=new G,m=.48,h=.9,g=new Map,_=new Map;function v(e,t,n){return`${Math.floor(e/n)},${Math.floor(t/n)}`}function y(e,t,n,r,i){let a=Math.floor(t/r),o=Math.floor(n/r);for(let r=-1;r<=1;r+=1)for(let s=-1;s<=1;s+=1){let c=`${a+s},${o+r}`,l=e.get(c);if(l)for(let e=0;e<l.length;e+=1){let r=l[e],a=t-r.x,o=n-r.z;if(a*a+o*o<i)return!1}}return!0}function b(e,t,n,r){let i=v(t,n,r),a=e.get(i);if(a){a.push({x:t,z:n});return}e.set(i,[{x:t,z:n}])}let x=new ba(1.05,1.7,1,1);x.translate(0,.85,0);let S=new ba(1.9,2.2,1,1);S.translate(0,1.1,0);let C=up(Gf,Kf,qf,.14),w=up(Jf,Yf,Xf,.16),T=new Di(x,C,c),E=new Di(x,C,c),D=new Di(S,w,l),O=new Di(S,w,l),k=[],A=Pf.waterExclusion.riverWidth+1.8,ee=A+9.6;for(let e=0;e<c;e+=1){let t=Math.random()<.52;if(!wp({terrainSampler:u,riverSamples:a,pondCenter:r,pondRadius:i,minRiverDistance:t?A:A+2.4,maxRiverDistance:t?ee:s.meadowRadius,targetPosition:d,targetNormal:f})){--e;continue}if(kp(d.x,d.z)){--e;continue}if(!y(g,d.x,d.z,m,.11560000000000002)){--e;continue}b(g,d.x,d.z,m),p.copy(d).addScaledVector(f,.002);let n=.72+Math.random()*1.08,o=Math.random()*Math.PI*2;$f.copy(f).normalize(),ep.setFromUnitVectors(Qf,$f),$.position.copy(p),tp.setFromAxisAngle($f,o),$.quaternion.copy(ep).multiply(tp),$.scale.set(n,n*(.9+Math.random()*.4),1),$.updateMatrix(),T.setMatrixAt(e,$.matrix);let c=$.matrix.clone();tp.setFromAxisAngle($f,o+Math.PI*.5),$.quaternion.copy(ep).multiply(tp),$.updateMatrix(),E.setMatrixAt(e,$.matrix);let l=$.matrix.clone();k.push({x:d.x,z:d.z,matrixA:c,matrixB:l})}let te=Pf.waterExclusion.riverWidth+5.4,j=te+8.8;for(let e=0;e<l;e+=1){if(!wp({terrainSampler:u,riverSamples:a,pondCenter:r,pondRadius:i,minRiverDistance:te,maxRiverDistance:j,targetPosition:d,targetNormal:f})){--e;continue}if(!y(_,d.x,d.z,h,.4624000000000001)){--e;continue}b(_,d.x,d.z,h),p.copy(d).addScaledVector(f,.003);let t=.72+Math.random()*.56,n=Math.random()*Math.PI*2;$f.copy(f).normalize(),ep.setFromUnitVectors(Qf,$f),$.position.copy(p),tp.setFromAxisAngle($f,n),$.quaternion.copy(ep).multiply(tp),$.scale.set(t,t*(.88+Math.random()*.42),1),$.updateMatrix(),D.setMatrixAt(e,$.matrix),tp.setFromAxisAngle($f,n+Math.PI*.5),$.quaternion.copy(ep).multiply(tp),$.updateMatrix(),O.setMatrixAt(e,$.matrix)}T.instanceMatrix.needsUpdate=!0,E.instanceMatrix.needsUpdate=!0,D.instanceMatrix.needsUpdate=!0,O.instanceMatrix.needsUpdate=!0,T.frustumCulled=!0,E.frustumCulled=!0,D.frustumCulled=!0,O.frustumCulled=!0,e.add(T),e.add(E),e.add(D),e.add(O);let ne=s.lodNearDistance*s.lodNearDistance,M=s.lodMidDistance*s.lodMidDistance,N=s.lodFarDistance*s.lodFarDistance,re=Math.max(1,s.lodMidStride||3),ie=Math.max(re+1,s.lodFarStride||8),ae=Math.max(.15,s.lodUpdateInterval||.35),oe=-1e3;function P(e){let t=0;for(let n=0;n<k.length;n+=1){let r=k[n],i=r.x-e.x,a=r.z-e.z,o=i*i+a*a,s=!1;o<=ne?s=!0:o<=M?s=n%re===0:o<=N&&(s=n%ie===0),s&&(T.setMatrixAt(t,r.matrixA),E.setMatrixAt(t,r.matrixB),t+=1)}T.count=t,E.count=t,T.instanceMatrix.needsUpdate=!0,E.instanceMatrix.needsUpdate=!0}return P(new G(0,0,24)),{update(e,t){e&&(t-oe<ae||(P(e),oe=t))}}}function jp(e,t){let n=e.map(()=>[]);for(let r=0;r<t.length;r+=1)n[Math.floor(Math.random()*e.length)].push(t[r]);return n}function Mp(e,t,n){if(n.length!==0)for(let r of t.parts){let t=new Di(r.geometry,r.material,n.length);for(let e=0;e<n.length;e+=1){let r=n[e];$.position.set(r.x,r.y,r.z),$.rotation.set(0,r.rotationY,0),$.scale.setScalar(r.scale),$.updateMatrix(),t.setMatrixAt(e,$.matrix)}t.instanceMatrix.needsUpdate=!0,e.add(t)}}function Np({count:e,sampler:t,getTerrainHeight:n,baseScaleFn:r,jitterY:i=.03,terrainMesh:a,validator:o,maxAttempts:s=24}){let c=[];for(let n=0;n<e;n+=1){let e=t();if(o)for(let n=0;n<s&&!o(e);n+=1)e=t();let n=xp(a,e),l=n.y+i;c.push({x:n.x,y:l,z:n.z,rotationY:Math.random()*Math.PI*2,scale:r()})}return c}function Pp(){let e=document.createElement(`canvas`);e.width=128,e.height=256;let t=e.getContext(`2d`);t.clearRect(0,0,e.width,e.height);let n=t.createRadialGradient(64,84,6,64,84,76);n.addColorStop(0,`rgba(173, 104, 56, 0.98)`),n.addColorStop(.45,`rgba(130, 72, 36, 0.95)`),n.addColorStop(1,`rgba(64, 38, 26, 0)`),t.fillStyle=n,t.beginPath(),t.ellipse(64,96,56,76,0,0,Math.PI*2),t.fill(),t.fillStyle=`rgba(78, 49, 34, 0.95)`,t.fillRect(58,120,12,124);let r=new ia(e);return r.colorSpace=Be,r.needsUpdate=!0,r}function Fp(e,t){if(t.length===0)return;let n=Pp(),r=new ba(1,1,1,1),i=new Ur({map:n,transparent:!0,alphaTest:.36,depthWrite:!1,color:12503449,side:2,fog:!0}),a=new Di(r,i,t.length),o=new Di(r,i,t.length);for(let e=0;e<t.length;e+=1){let n=t[e],r=8.6+Math.random()*5.4,i=r*(.38+Math.random()*.18);$.position.set(n.x,n.y+r*.5,n.z),$.rotation.set(0,n.rotationY,0),$.scale.set(i,r,1),$.updateMatrix(),a.setMatrixAt(e,$.matrix),$.rotation.set(0,n.rotationY+Math.PI*.5,0),$.updateMatrix(),o.setMatrixAt(e,$.matrix)}a.instanceMatrix.needsUpdate=!0,o.instanceMatrix.needsUpdate=!0,e.add(a),e.add(o)}function Ip(e,t,n,r,i,a,o,s){let c=Pf.trees,l=Np({count:c.totalCount,sampler:()=>Math.random()<.68?vp(c.edgeInner,c.edgeOuter):yp(r,c.nearRiverOffsetMin,c.nearRiverOffsetMax),getTerrainHeight:n,baseScaleFn:()=>.82+Math.random()*.5,jitterY:.01,terrainMesh:s,validator:e=>Math.hypot(e.x-i.x,e.z-i.z)<a+c.centerExclusionRadius?!1:!Op(e.x,e.z,o,i,a)}),u=[],d=[];for(let e of l)Math.hypot(e.x-i.x,e.z-i.z)>c.impostorStartRadius&&Math.random()<c.impostorRatio?d.push(e):u.push(e);let f=jp(t,u);for(let n=0;n<t.length;n+=1){let r=t[n];Mp(e,r,f[n].map(e=>({...e,scale:e.scale*r.baseScale})))}Fp(e,d),console.info(`Tree LOD distribution`,{detailed:u.length,impostors:d.length})}function Lp(e,t,n,r,i,a,o,s){let c=Pf.flowers,l=jp(t,Np({count:c.count,sampler:()=>Math.random()<.84?yp(r,c.riverOffsetMin,c.riverOffsetMax):bp(i,a,c.pondRingMin,c.pondRingMax),getTerrainHeight:n,baseScaleFn:()=>.78+Math.random()*.6,jitterY:.012,terrainMesh:s,validator:e=>!Op(e.x,e.z,o,i,a)}));for(let n=0;n<t.length;n+=1){let r=t[n];Mp(e,r,l[n].map(e=>({...e,scale:e.scale*r.baseScale})))}}function Rp(e){let t=gp(e,sp,5078341),n=gp(e,cp,16748473);return{trees:t.length>0?t:_p(`trees`),flowers:n.length>0?n:_p(`flowers`)}}function zp(e,t,n,r,i,a,o){let s=Tp(n,110);Ip(e,a.trees,t,n,r,i,s,o),Lp(e,a.flowers,t,n,r,i,s,o);let c=Ap(e,t,n,r,i,s,o);return{update(e,t){c&&c.update&&c.update(e,t)}}}function Bp(e,t,n,r,i,a,o){let s=new Dd;return new Promise(c=>{s.load(a,a=>{e.add(a.scene),a.scene.visible=!1,a.scene.updateMatrixWorld(!0);let s=new Map;a.scene.traverse(e=>{e.isMesh&&(console.log(e.name),s.set(e.name,e))});let l=Rp(s);console.info(`Manual vegetation classification`,{trees:l.trees.map(e=>e.name),flowers:l.flowers.map(e=>e.name),groundCover:[`texture-prof-herbe`,`texture-prof-buisson`]}),c(zp(e,t,n,r,i,l,o))},void 0,()=>{c(zp(e,t,n,r,i,{trees:_p(`trees`),flowers:_p(`flowers`)},o))})})}function Vp(){let e=document.createElement(`canvas`);e.width=64,e.height=64;let t=e.getContext(`2d`),n=t.createRadialGradient(32,32,0,32,32,32);n.addColorStop(0,`rgba(255, 250, 214, 1)`),n.addColorStop(.25,`rgba(255, 240, 160, 0.8)`),n.addColorStop(.7,`rgba(255, 200, 100, 0.12)`),n.addColorStop(1,`rgba(255, 180, 80, 0)`),t.fillStyle=n,t.fillRect(0,0,64,64);let r=new ia(e);return r.colorSpace=Be,r}function Hp(e){let t=Math.random(),n=e.getPointAt(t),r=e.getTangentAt(t).normalize(),i=new G(-r.z,0,r.x).normalize(),a=Math.random()<.5?-1:1,o=1.4+Math.random()*4.2;return new G(n.x+i.x*o*a,0,n.z+i.z*o*a)}function Up(){let e=Math.random()*Math.PI*2,t=28+Math.sqrt(Math.random())*72;return new G(Math.cos(e)*t,0,Math.sin(e)*t)}function Wp(e,t,n,r,i){let a=new Float32Array(900*3),o=new Float32Array(900*3),s=new Float32Array(900);for(let e=0;e<900;e+=1){let n=Math.random()<.55?Hp(t):Up();n.y=i(n.x,n.z)+2.6+Math.random()*4.8;let r=e*3;a[r]=n.x,a[r+1]=n.y,a[r+2]=n.z,o[r]=n.x,o[r+1]=n.y,o[r+2]=n.z,s[e]=Math.random()*Math.PI*2}let c=new kr;c.setAttribute(`position`,new mr(a,3));let l=new Xi({map:Vp(),size:.54,transparent:!0,opacity:1,depthWrite:!1,blending:2,vertexColors:!1,color:16773537,sizeAttenuation:!0});l.toneMapped=!1;let u=new ta(c,l);return u.renderOrder=10,u.frustumCulled=!1,e.add(u),{update(e){let t=c.attributes.position,n=t.array;for(let t=0;t<900;t+=1){let r=t*3,i=s[t];n[r]=o[r]+Math.sin(e*.31+i)*.32,n[r+1]=o[r+1]+Math.sin(e*.84+i*1.7)*.52+Math.cos(e*.46+i)*.16,n[r+2]=o[r+2]+Math.cos(e*.36+i*.9)*.32}t.needsUpdate=!0}}}var Gp=new Tn;function Kp(e,t){return e+Math.random()*(t-e)}function qp(){return{x:Kp(-70,70),y:Kp(8,24),z:Kp(-70,70),fallSpeed:Kp(.35,.8),drift:Kp(.35,1.2),spin:Kp(-2.1,2.1),tilt:Kp(-.8,.8),yaw:Kp(0,Math.PI*2),phase:Kp(0,Math.PI*2)}}function Jp(e){e.x=Kp(-72,72),e.y=Kp(14,26),e.z=Kp(-72,72),e.fallSpeed=Kp(.35,.8),e.drift=Kp(.35,1.2),e.spin=Kp(-2.1,2.1),e.tilt=Kp(-.8,.8),e.yaw=Kp(0,Math.PI*2),e.phase=Kp(0,Math.PI*2)}function Yp(e,t){let n=new Di(new ba(.32,.14),new Ur({color:13864783,transparent:!0,opacity:.88,side:2}),28),r=[];for(let e=0;e<28;e+=1){let t=qp();r.push(t),Gp.position.set(t.x,t.y,t.z),Gp.rotation.set(t.tilt,t.yaw,t.phase),Gp.scale.setScalar(Kp(.8,1.2)),Gp.updateMatrix(),n.setMatrixAt(e,Gp.matrix)}return n.instanceMatrix.needsUpdate=!0,e.add(n),{update(e,i){for(let a=0;a<r.length;a+=1){let o=r[a];o.y-=o.fallSpeed*i,o.x+=Math.sin(e*.9+o.phase)*o.drift*i,o.z+=Math.cos(e*.7+o.phase*.6)*o.drift*i,o.yaw+=o.spin*i;let s=t(o.x,o.z)+.22;o.y<=s&&Jp(o),Gp.position.set(o.x,o.y,o.z),Gp.rotation.set(o.tilt,o.yaw,o.phase),Gp.scale.setScalar(1),Gp.updateMatrix(),n.setMatrixAt(a,Gp.matrix)}n.instanceMatrix.needsUpdate=!0}}}var Xp={type:`change`},Zp={type:`start`},Qp={type:`end`},$p=new Hr,em=new ji,tm=Math.cos(70*kt.DEG2RAD),nm=new G,rm=2*Math.PI,im={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},am=1e-6,om=class extends ls{constructor(n,r=null){super(n,r),this.state=im.NONE,this.target=new G,this.cursor=new G,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:`ArrowLeft`,UP:`ArrowUp`,RIGHT:`ArrowRight`,BOTTOM:`ArrowDown`},this.mouseButtons={LEFT:e.ROTATE,MIDDLE:e.DOLLY,RIGHT:e.PAN},this.touches={ONE:t.ROTATE,TWO:t.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._cursorStyle=`auto`,this._domElementKeyEvents=null,this._lastPosition=new G,this._lastQuaternion=new At,this._lastTargetPosition=new G,this._quat=new At().setFromUnitVectors(n.up,new G(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new cs,this._sphericalDelta=new cs,this._scale=1,this._panOffset=new G,this._rotateStart=new W,this._rotateEnd=new W,this._rotateDelta=new W,this._panStart=new W,this._panEnd=new W,this._panDelta=new W,this._dollyStart=new W,this._dollyEnd=new W,this._dollyDelta=new W,this._dollyDirection=new G,this._mouse=new W,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=cm.bind(this),this._onPointerDown=sm.bind(this),this._onPointerUp=lm.bind(this),this._onContextMenu=gm.bind(this),this._onMouseWheel=fm.bind(this),this._onKeyDown=pm.bind(this),this._onTouchStart=mm.bind(this),this._onTouchMove=hm.bind(this),this._onMouseDown=um.bind(this),this._onMouseMove=dm.bind(this),this._interceptControlDown=_m.bind(this),this._interceptControlUp=vm.bind(this),this.domElement!==null&&this.connect(this.domElement),this.update()}set cursorStyle(e){this._cursorStyle=e,e===`grab`?this.domElement.style.cursor=`grab`:this.domElement.style.cursor=`auto`}get cursorStyle(){return this._cursorStyle}connect(e){super.connect(e),this.domElement.addEventListener(`pointerdown`,this._onPointerDown),this.domElement.addEventListener(`pointercancel`,this._onPointerUp),this.domElement.addEventListener(`contextmenu`,this._onContextMenu),this.domElement.addEventListener(`wheel`,this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener(`keydown`,this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction=`none`}disconnect(){this.domElement.removeEventListener(`pointerdown`,this._onPointerDown),this.domElement.ownerDocument.removeEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.removeEventListener(`pointerup`,this._onPointerUp),this.domElement.removeEventListener(`pointercancel`,this._onPointerUp),this.domElement.removeEventListener(`wheel`,this._onMouseWheel),this.domElement.removeEventListener(`contextmenu`,this._onContextMenu),this.stopListenToKeyEvents(),this.domElement.getRootNode().removeEventListener(`keydown`,this._interceptControlDown,{capture:!0}),this.domElement.style.touchAction=``}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(e){e.addEventListener(`keydown`,this._onKeyDown),this._domElementKeyEvents=e}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener(`keydown`,this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(Xp),this.update(),this.state=im.NONE}pan(e,t){this._pan(e,t),this.update()}dollyIn(e){this._dollyIn(e),this.update()}dollyOut(e){this._dollyOut(e),this.update()}rotateLeft(e){this._rotateLeft(e),this.update()}rotateUp(e){this._rotateUp(e),this.update()}update(e=null){let t=this.object.position;nm.copy(t).sub(this.target),nm.applyQuaternion(this._quat),this._spherical.setFromVector3(nm),this.autoRotate&&this.state===im.NONE&&this._rotateLeft(this._getAutoRotationAngle(e)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let n=this.minAzimuthAngle,r=this.maxAzimuthAngle;isFinite(n)&&isFinite(r)&&(n<-Math.PI?n+=rm:n>Math.PI&&(n-=rm),r<-Math.PI?r+=rm:r>Math.PI&&(r-=rm),n<=r?this._spherical.theta=Math.max(n,Math.min(r,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(n+r)/2?Math.max(n,this._spherical.theta):Math.min(r,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let i=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{let e=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),i=e!=this._spherical.radius}if(nm.setFromSpherical(this._spherical),nm.applyQuaternion(this._quatInverse),t.copy(this.target).add(nm),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let e=null;if(this.object.isPerspectiveCamera){let t=nm.length();e=this._clampDistance(t*this._scale);let n=t-e;this.object.position.addScaledVector(this._dollyDirection,n),this.object.updateMatrixWorld(),i=!!n}else if(this.object.isOrthographicCamera){let t=new G(this._mouse.x,this._mouse.y,0);t.unproject(this.object);let n=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),i=n!==this.object.zoom;let r=new G(this._mouse.x,this._mouse.y,0);r.unproject(this.object),this.object.position.sub(r).add(t),this.object.updateMatrixWorld(),e=nm.length()}else console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled.`),this.zoomToCursor=!1;e!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(e).add(this.object.position):($p.origin.copy(this.object.position),$p.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot($p.direction))<tm?this.object.lookAt(this.target):(em.setFromNormalAndCoplanarPoint(this.object.up,this.target),$p.intersectPlane(em,this.target))))}else if(this.object.isOrthographicCamera){let e=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),e!==this.object.zoom&&(this.object.updateProjectionMatrix(),i=!0)}return this._scale=1,this._performCursorZoom=!1,i||this._lastPosition.distanceToSquared(this.object.position)>am||8*(1-this._lastQuaternion.dot(this.object.quaternion))>am||this._lastTargetPosition.distanceToSquared(this.target)>am?(this.dispatchEvent(Xp),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(e){return e===null?rm/60/60*this.autoRotateSpeed:rm/60*this.autoRotateSpeed*e}_getZoomScale(e){let t=Math.abs(e*.01);return .95**(this.zoomSpeed*t)}_rotateLeft(e){this._sphericalDelta.theta-=e}_rotateUp(e){this._sphericalDelta.phi-=e}_panLeft(e,t){nm.setFromMatrixColumn(t,0),nm.multiplyScalar(-e),this._panOffset.add(nm)}_panUp(e,t){this.screenSpacePanning===!0?nm.setFromMatrixColumn(t,1):(nm.setFromMatrixColumn(t,0),nm.crossVectors(this.object.up,nm)),nm.multiplyScalar(e),this._panOffset.add(nm)}_pan(e,t){let n=this.domElement;if(this.object.isPerspectiveCamera){let r=this.object.position;nm.copy(r).sub(this.target);let i=nm.length();i*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*e*i/n.clientHeight,this.object.matrix),this._panUp(2*t*i/n.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(e*(this.object.right-this.object.left)/this.object.zoom/n.clientWidth,this.object.matrix),this._panUp(t*(this.object.top-this.object.bottom)/this.object.zoom/n.clientHeight,this.object.matrix)):(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - pan disabled.`),this.enablePan=!1)}_dollyOut(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=e:(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.`),this.enableZoom=!1)}_dollyIn(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=e:(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.`),this.enableZoom=!1)}_updateZoomParameters(e,t){if(!this.zoomToCursor)return;this._performCursorZoom=!0;let n=this.domElement.getBoundingClientRect(),r=e-n.left,i=t-n.top,a=n.width,o=n.height;this._mouse.x=r/a*2-1,this._mouse.y=-(i/o)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(e){return Math.max(this.minDistance,Math.min(this.maxDistance,e))}_handleMouseDownRotate(e){this._rotateStart.set(e.clientX,e.clientY)}_handleMouseDownDolly(e){this._updateZoomParameters(e.clientX,e.clientX),this._dollyStart.set(e.clientX,e.clientY)}_handleMouseDownPan(e){this._panStart.set(e.clientX,e.clientY)}_handleMouseMoveRotate(e){this._rotateEnd.set(e.clientX,e.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);let t=this.domElement;this._rotateLeft(rm*this._rotateDelta.x/t.clientHeight),this._rotateUp(rm*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(e){this._dollyEnd.set(e.clientX,e.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(e){this._panEnd.set(e.clientX,e.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(e){this._updateZoomParameters(e.clientX,e.clientY),e.deltaY<0?this._dollyIn(this._getZoomScale(e.deltaY)):e.deltaY>0&&this._dollyOut(this._getZoomScale(e.deltaY)),this.update()}_handleKeyDown(e){let t=!1;switch(e.code){case this.keys.UP:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(rm*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),t=!0;break;case this.keys.BOTTOM:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(-rm*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),t=!0;break;case this.keys.LEFT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(rm*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),t=!0;break;case this.keys.RIGHT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(-rm*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),t=!0;break}t&&(e.preventDefault(),this.update())}_handleTouchStartRotate(e){if(this._pointers.length===1)this._rotateStart.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._rotateStart.set(n,r)}}_handleTouchStartPan(e){if(this._pointers.length===1)this._panStart.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._panStart.set(n,r)}}_handleTouchStartDolly(e){let t=this._getSecondPointerPosition(e),n=e.pageX-t.x,r=e.pageY-t.y,i=Math.sqrt(n*n+r*r);this._dollyStart.set(0,i)}_handleTouchStartDollyPan(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enablePan&&this._handleTouchStartPan(e)}_handleTouchStartDollyRotate(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enableRotate&&this._handleTouchStartRotate(e)}_handleTouchMoveRotate(e){if(this._pointers.length==1)this._rotateEnd.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._rotateEnd.set(n,r)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);let t=this.domElement;this._rotateLeft(rm*this._rotateDelta.x/t.clientHeight),this._rotateUp(rm*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(e){if(this._pointers.length===1)this._panEnd.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._panEnd.set(n,r)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(e){let t=this._getSecondPointerPosition(e),n=e.pageX-t.x,r=e.pageY-t.y,i=Math.sqrt(n*n+r*r);this._dollyEnd.set(0,i),this._dollyDelta.set(0,(this._dollyEnd.y/this._dollyStart.y)**+this.zoomSpeed),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);let a=(e.pageX+t.x)*.5,o=(e.pageY+t.y)*.5;this._updateZoomParameters(a,o)}_handleTouchMoveDollyPan(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enablePan&&this._handleTouchMovePan(e)}_handleTouchMoveDollyRotate(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enableRotate&&this._handleTouchMoveRotate(e)}_addPointer(e){this._pointers.push(e.pointerId)}_removePointer(e){delete this._pointerPositions[e.pointerId];for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId){this._pointers.splice(t,1);return}}_isTrackingPointer(e){for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId)return!0;return!1}_trackPointer(e){let t=this._pointerPositions[e.pointerId];t===void 0&&(t=new W,this._pointerPositions[e.pointerId]=t),t.set(e.pageX,e.pageY)}_getSecondPointerPosition(e){let t=e.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[t]}_customWheelEvent(e){let t=e.deltaMode,n={clientX:e.clientX,clientY:e.clientY,deltaY:e.deltaY};switch(t){case 1:n.deltaY*=16;break;case 2:n.deltaY*=100;break}return e.ctrlKey&&!this._controlActive&&(n.deltaY*=10),n}};function sm(e){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(e.pointerId),this.domElement.ownerDocument.addEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.addEventListener(`pointerup`,this._onPointerUp)),!this._isTrackingPointer(e)&&(this._addPointer(e),e.pointerType===`touch`?this._onTouchStart(e):this._onMouseDown(e),this._cursorStyle===`grab`&&(this.domElement.style.cursor=`grabbing`)))}function cm(e){this.enabled!==!1&&(e.pointerType===`touch`?this._onTouchMove(e):this._onMouseMove(e))}function lm(e){switch(this._removePointer(e),this._pointers.length){case 0:this.domElement.releasePointerCapture(e.pointerId),this.domElement.ownerDocument.removeEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.removeEventListener(`pointerup`,this._onPointerUp),this.dispatchEvent(Qp),this.state=im.NONE,this._cursorStyle===`grab`&&(this.domElement.style.cursor=`grab`);break;case 1:let t=this._pointers[0],n=this._pointerPositions[t];this._onTouchStart({pointerId:t,pageX:n.x,pageY:n.y});break}}function um(t){let n;switch(t.button){case 0:n=this.mouseButtons.LEFT;break;case 1:n=this.mouseButtons.MIDDLE;break;case 2:n=this.mouseButtons.RIGHT;break;default:n=-1}switch(n){case e.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(t),this.state=im.DOLLY;break;case e.ROTATE:if(t.ctrlKey||t.metaKey||t.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(t),this.state=im.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(t),this.state=im.ROTATE}break;case e.PAN:if(t.ctrlKey||t.metaKey||t.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(t),this.state=im.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(t),this.state=im.PAN}break;default:this.state=im.NONE}this.state!==im.NONE&&this.dispatchEvent(Zp)}function dm(e){switch(this.state){case im.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(e);break;case im.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(e);break;case im.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(e);break}}function fm(e){this.enabled===!1||this.enableZoom===!1||this.state!==im.NONE||(e.preventDefault(),this.dispatchEvent(Zp),this._handleMouseWheel(this._customWheelEvent(e)),this.dispatchEvent(Qp))}function pm(e){this.enabled!==!1&&this._handleKeyDown(e)}function mm(e){switch(this._trackPointer(e),this._pointers.length){case 1:switch(this.touches.ONE){case t.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(e),this.state=im.TOUCH_ROTATE;break;case t.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(e),this.state=im.TOUCH_PAN;break;default:this.state=im.NONE}break;case 2:switch(this.touches.TWO){case t.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(e),this.state=im.TOUCH_DOLLY_PAN;break;case t.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(e),this.state=im.TOUCH_DOLLY_ROTATE;break;default:this.state=im.NONE}break;default:this.state=im.NONE}this.state!==im.NONE&&this.dispatchEvent(Zp)}function hm(e){switch(this._trackPointer(e),this.state){case im.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(e),this.update();break;case im.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(e),this.update();break;case im.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(e),this.update();break;case im.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(e),this.update();break;default:this.state=im.NONE}}function gm(e){this.enabled!==!1&&e.preventDefault()}function _m(e){e.key===`Control`&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener(`keyup`,this._interceptControlUp,{passive:!0,capture:!0}))}function vm(e){e.key===`Control`&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener(`keyup`,this._interceptControlUp,{passive:!0,capture:!0}))}function ym({camera:e,domElement:t,getTerrainHeight:n,riverCurve:r,pondCenter:i}){let a=new om(e,t);a.enableDamping=!0,a.dampingFactor=.07,a.enablePan=!0,a.enableRotate=!0,a.autoRotate=!1,a.minDistance=6,a.maxDistance=150,a.minPolarAngle=.12,a.maxPolarAngle=1.52,a.screenSpacePanning=!0,a.zoomToCursor=!0;let o=n(i.x,i.z)+2.1;a.target.set(i.x,o,i.z),e.position.set(i.x+46,o+20,i.z+34),e.lookAt(a.target);let s={desiredFov:46};e.fov=s.desiredFov,e.updateProjectionMatrix();let c=e=>{let t=(e.key||``).toLowerCase();if(t===`p`){e.preventDefault(),s.desiredFov=kt.clamp(s.desiredFov-Nf.zoomStepKey*.08,Nf.minFov,Nf.maxFov);return}t===`m`&&(e.preventDefault(),s.desiredFov=kt.clamp(s.desiredFov+Nf.zoomStepKey*.08,Nf.minFov,Nf.maxFov))};window.addEventListener(`keydown`,c,{passive:!1});function l(t,n){a.update(),e.fov=kt.lerp(e.fov,s.desiredFov,Math.min(1,n*9)),e.updateProjectionMatrix()}function u(){window.removeEventListener(`keydown`,c),a.dispose()}return{update:l,dispose:u}}var bm=new G(-44.7,3.25,28.42),xm=3.8,Sm=new G(0,1,0);function Cm(e,t,n,r=.7){let i=e(t+r,n),a=e(t-r,n),o=e(t,n+r),s=e(t,n-r);return new G(a-i,r*2,s-o).normalize()}function wm(e,t,n){if(e){let t=null,r=1/0;for(let i=0;i<=80;i+=1){let a=e.getPointAt(i/80),o=a.x-n.x,s=a.z-n.z,c=o*o+s*s;c<r&&(r=c,t=a)}if(t)return t}return t||new G(0,n.y,0)}function Tm(e,t,n,r){let i=new Dd;function a(){let t=new ti(new xa(.8,16,16),new Ur({color:16724804}));return t.position.copy(bm),e.add(t),{deer:t,update(){}}}return new Promise(o=>{i.load(`/cerf/23870b8f869b49b8ad9b09a020bedd30_Textured.gltf`,i=>{let a=new En,s=new En,c=i.scene;c.rotation.set(-Math.PI*.5,0,0),c.updateMatrixWorld(!0);let l=new Xn().setFromObject(c),u=new G;l.getSize(u);let d=xm/Math.max(.001,u.y);c.scale.setScalar(d),c.updateMatrixWorld(!0);let f=new Xn().setFromObject(c).min.y,p=Number.isFinite(bm.y)?bm.y:t(bm.x,bm.z),m=Cm(t,bm.x,bm.z);c.position.set(0,-f+.02,0);let h=wm(n,r,bm),g=Math.atan2(h.x-bm.x,h.z-bm.z);s.rotation.y=g,c.traverse(e=>{e.isMesh&&(e.castShadow=!1,e.receiveShadow=!1)}),a.position.set(bm.x,p,bm.z),a.quaternion.setFromUnitVectors(Sm,m),s.add(c),a.add(s),a.updateMatrixWorld(!0),a.matrixAutoUpdate=!1,s.matrixAutoUpdate=!1,c.matrixAutoUpdate=!1,e.add(a),console.info(`Deer loaded`,{position:a.position.toArray(),scale:d}),o({deer:a,update(){}})},void 0,e=>{console.warn(`Failed to load deer model`,e),o(a())})})}function Em(){let e=document.createElement(`div`);e.style.position=`fixed`,e.style.top=`12px`,e.style.right=`12px`,e.style.padding=`8px 10px`,e.style.borderRadius=`8px`,e.style.fontFamily=`ui-monospace, SFMono-Regular, Menlo, monospace`,e.style.fontSize=`12px`,e.style.color=`#e8fff0`,e.style.background=`rgba(8, 16, 14, 0.6)`,e.style.backdropFilter=`blur(4px)`,e.style.border=`1px solid rgba(173, 255, 207, 0.2)`,e.style.zIndex=`1000`,e.style.pointerEvents=`none`,e.textContent=`FPS: --`,document.body.appendChild(e);let t=0,n=performance.now();return{update(r){t+=1;let i=r-n;if(i>=500){let a=t*1e3/i,o=a>=60;e.textContent=`FPS: ${a.toFixed(1)} ${o?`OK`:`LOW`}`,e.style.color=o?`#d5ffe4`:`#ffe2c6`,t=0,n=r}},dispose(){e.remove()}}}function Dm(){let e=document.createElement(`div`);e.style.position=`fixed`,e.style.top=`52px`,e.style.right=`12px`,e.style.zIndex=`1000`,e.style.display=`flex`,e.style.alignItems=`center`,e.style.justifyContent=`center`;let t=document.createElement(`button`);t.type=`button`,t.setAttribute(`aria-label`,`Toggle forest ambience`),t.style.width=`42px`,t.style.height=`42px`,t.style.borderRadius=`8px`,t.style.border=`1px solid rgba(173, 255, 207, 0.2)`,t.style.background=`rgba(8, 16, 14, 0.6)`,t.style.backdropFilter=`blur(4px)`,t.style.cursor=`pointer`,t.style.display=`flex`,t.style.alignItems=`center`,t.style.justifyContent=`center`,t.style.padding=`0`,t.style.color=`#e8fff0`,t.style.boxShadow=`none`,t.style.touchAction=`manipulation`;let n=document.createElement(`img`);n.alt=``,n.width=24,n.height=24,n.style.display=`block`,n.style.pointerEvents=`none`,t.appendChild(n);let r=new Audio(`/audio/Forest_ambience.ogg`);r.loop=!0,r.preload=`auto`,r.volume=.45;let i=!1;function a(){n.src=i?`/audio/volume-up-32.svg`:`/audio/muet-32.svg`,t.title=i?`Mute ambience`:`Play ambience`,t.setAttribute(`aria-pressed`,String(i))}async function o(){try{r.paused?(await r.play(),i=!0):(r.pause(),i=!1),a()}catch(e){console.warn(`Unable to toggle ambience audio`,e)}}return t.addEventListener(`click`,o),a(),e.appendChild(t),document.body.appendChild(e),{audio:r,wrapper:e,button:t,dispose(){r.pause(),r.src=``,t.removeEventListener(`click`,o),e.remove()}}}async function Om(){let{scene:e,camera:t,renderer:n,clock:r,composer:i}=Uu(document.querySelector(`#app`)),a=Em(),o=Dm();Ku(e,n);let s=vd(e,n),{getTerrainHeight:c}=s,l=Cd(e,c),u=ym({camera:t,domElement:n.domElement,getTerrainHeight:c,riverCurve:l.riverCurve,pondCenter:l.pondCenter}),d=Wp(e,l.riverCurve,l.pondCenter,l.pondRadius,c),f=Yp(e,c),p=await Bp(e,c,l.riverCurve,l.pondCenter,l.pondRadius,Ou,s.terrain),m=await Tm(e,c,l.riverCurve,l.pondCenter);await Wf(e,c),window.addEventListener(`resize`,()=>{Wu(t,n,i)}),window.addEventListener(`beforeunload`,()=>{u.dispose(),a.dispose(),o.dispose()});function h(e=performance.now()){let n=r.getElapsedTime(),o=Math.min(r.getDelta(),.033);u.update(n,o),l.update(n),d.update(n),f.update(n,o),p&&p.update&&p.update(t.position,n),m&&m.update&&m.update(o),a.update(e),i.render(),requestAnimationFrame(h)}h()}Om().catch(e=>{console.error(`Failed to initialize forest scene:`,e)});